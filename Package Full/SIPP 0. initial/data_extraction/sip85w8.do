log using sip85w8, text replace
set mem 1000m
*This program reads the 1985 SIPP Wave 8 Core Data File 
...
*by Jean Roth Wed Jun  9 16:48:09 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip85w8
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1985\sip85w8.dat"
...
clear
quietly infile using "${extractcodedir}\sip85w8"
