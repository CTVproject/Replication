log using sip84w9, text replace
set mem 1000m
*This program reads the 1984 SIPP Wave 9 Core Data File 
...
*by Jean Roth Wed Jun  9 17:04:39 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip84w9
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1984\sip84w9.dat"
...
clear
quietly infile using "${extractcodedir}\sip84w9"
