log using sip88rt5, text replace
set mem 1000m
*This program reads the 1988 SIPP Wave 5 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:05:20 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip88rt5
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1988\sip88rt5.dat"
...
clear
quietly infile using "${extractcodedir}\sip88rt5"
...
label define tm_ifc9l
	...
	1           "Imputed TM9638"                
;
label values tm_ifc10 tm_ifc1d;
label define tm_ifc1d
	0           "Not imputed"                   
	1           "Imputed TM9642"                
;
