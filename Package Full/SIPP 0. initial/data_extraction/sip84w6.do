log using sip84w6, text replace
set mem 1000m

/*------------------------------------------------

  This program reads the 1984 SIPP Wave 6 Core Data File 
...
****************************************************************
  ...
  by Jean Roth Mon Apr 17 09:11:10 EDT 2006
...
local dat_name "sipp84w6.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "sipp84w6.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "${extractcodedir}\sip84w6.dct"
...
label define incsourc
	...
	12          "Employer or union temporary sickness"
	...
	36          "Income from paid up life insurance"
