log using sip86rt5, text replace
set mem 1000m
*This program reads the 1986 SIPP Wave 5 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:31:31 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip86rt5
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1986\sip86rt5.dat"
...
clear
quietly infile using "${extractcodedir}\sip86rt5"
