...
clear
quietly infile using "${extractcodedir}\sip93w7"
...
label define edasst  
	...
	2           "No"                            
;
label values gibill   gibill; 
label define gibill  
	0           "No or not in universe"         
	1           "Yes"                           
;
label values othvet   othvet; 
label define othvet  
	0           "No or not in universe"         
	1           "Yes"                           
;
label values wkstdy   wkstdy; 
label define wkstdy  
	0           "No or not in universe"         
	1           "Yes"                           
;
label values pell     pell;   
label define pell    
	0           "No or not in universe"         
	1           "Yes"                           
;
label values supped   supped; 
label define supped  
	0           "No or not in universe"         
	1           "Yes"                           
;
label values ndsl     ndsl;   
label define ndsl    
	0           "No or not in universe"         
	1           "Yes"                           
;
label values stloan   stloan; 
label define stloan  
	0           "No or not in universe"         
	1           "Yes"                           
;
label values plus     plus;   
label define plus    
	0           "No or not in universe"         
	1           "Yes"                           
;
label values emplyr   emplyr; 
label define emplyr  
	0           "No or not in universe"         
	1           "Yes"                           
;
label values fsship   fsship; 
label define fsship  
	0           "No or not in universe"         
	1           "Yes"                           
;
label values othaid   othaid; 
label define othaid  
	0           "No or not in universe"         
	1           "Yes"                           
;
...
label define rrday   
	...
	3           "Other"                         
;
label values ssicovrg ssicovrg;
label define ssicovrg
	0           "Not in universe"               
	1           "Adults"                        
	2           "Children"                      
