log using sip85rt3, text replace
set mem 1000m
*This program reads the 1985 SIPP Wave 3 Rectangular and Topical Data File 
...
*NOTE: The original .ddf had old MSA values ; 
*by Jean Roth Wed Jun  9 16:31:47 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip85rt3
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1985\sip85rt3.dat"
...
clear
quietly infile using "${extractcodedir}\sip85rt3"
...
label define state   
	...
	53          "Washington"                    
	55          "Wisconsin"                     
	90          "Idaho, New Mexico, South Dakota,"
...
label define u_hhmem 
	...
	2           "No"                            
;
label values u_reasn1 u_reasnm;
label define u_reasnm
...
label define tm8608l 
	...
	3           "OCCUPIED WITHOUT CASH RENT - SKIP TO TM8658"
;
...
;
label values hh_sum01 hh_sum0e;
label define hh_sum0e
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum03 hh_sum0k;
label define hh_sum0k
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum04 hh_sum0l;
label define hh_sum0l
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum05 hh_sum0m;
label define hh_sum0m
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum06 hh_sum0n;
label define hh_sum0n
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum07 hh_sum0o;
label define hh_sum0o
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum08 hh_sum0p;
label define hh_sum0p
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum09 hh_sum0q;
label define hh_sum0q
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum10 hh_sum1e;
label define hh_sum1e
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum11 hh_sum1k;
label define hh_sum1k
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum12 hh_sum1l;
label define hh_sum1l
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum13 hh_sum1m;
label define hh_sum1m
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum14 hh_sum1n;
label define hh_sum1n
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum15 hh_sum1o;
label define hh_sum1o
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum16 hh_sum1p;
label define hh_sum1p
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum17 hh_sum1q;
label define hh_sum1q
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum18 hh_sum1r;
label define hh_sum1r
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum19 hh_sum1s;
label define hh_sum1s
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values hh_sum20 hh_sum2e;
label define hh_sum2e
	0           "NOT APPLICABLE OR NO"          
	1           "YES"                           
;
label values tm_ip121 tm_ip12e;
label define tm_ip12e
	0           "NOT IMPUTED"                   
	1           "IMPUTED TM8538"                
	2           "IMPUTED TM8539"                
	3           "IMPUTED TM8538 & TM8539"       
;
label values tm_ip123 tm_ip12k;
label define tm_ip12k
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm_ip124 tm_ip12l;
label define tm_ip12l
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm_ip126 tm_ip12m;
label define tm_ip12m
	0           "NOT IMPUTED"                   
	1           "IMPUTED TM8568"                
	2           "IMPUTED TM8569"                
	3           "IMPUTED TM8568 & TM8569"       
;
label values tm_ip127 tm_ip12n;
label define tm_ip12n
	0           "NOT IMPUTED"                   
	1           "IMPUTED TM8570"                
	2           "IMPUTED TM8571"                
	3           "IMPUTED TM8570 & TM8571"       
;
label values tm_ip163 tm_ip16e;
label define tm_ip16e
	0           "NOT CALCULATED"                
	1           "CALCULATED"                    
;
...
label define tm8310l 
	0           "NOT APPLICABLE - SKIP TO TM8312"
;
