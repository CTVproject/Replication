log using sip89rt3, text replace
set mem 1000m
*This program reads the 1989 SIPP Wave 3 Rectangular and Topical Data File 
...
*by Jean Roth Tue Jun  8 13:14:01 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip89rt3
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1989\sip89rt3.dat"
...
;
label values pp_mis1  pp_mis; 
label values pp_mis2  pp_mis; 
label values pp_mis3  pp_mis; 
label values pp_mis4  pp_mis; 
label values pp_mis5  pp_mis; 
label define pp_mis  
	1           "Interview"                     
	2           "Noninterview"                  
;
...
label define pw_intvw
	...
	4           "Noninterview - type-Z other"   
;
label values rrp_1    rrp;    
label values rrp_2    rrp;    
label values rrp_3    rrp;    
label values rrp_4    rrp;    
label values rrp_5    rrp;    
label define rrp     
	0           "Not in universe"               
...
;
label values age_1    age;    
label values age_2    age;    
label values age_3    age;    
label values age_4    age;    
label values age_5    age;    
label define age     
...
label define race    
	...
	4           "Asian or Pacific Islander"     
;
label values ms_1     ms;     
label values ms_2     ms;     
label values ms_3     ms;     
label values ms_4     ms;     
label values ms_5     ms;     
label define ms      
	0           "Not a sample person in this mont"
	1           "Married, spouse present"       
	2           "Married, spouse absent"        
	3           "Widowed"                       
	4           "Divorced"                      
...
;
label values famnum1  famnum; 
label values famnum2  famnum; 
label values famnum3  famnum; 
label values famnum4  famnum; 
label values famnum5  famnum; 
label define famnum  
	0           "Not applicable or not a sample"
;
...
label define pop_stat
	...
	2           "Child (under 15 at interview)" 
;
label values pnsp_1   pnsp;   
label values pnsp_2   pnsp;   
label values pnsp_3   pnsp;   
label values pnsp_4   pnsp;   
label values pnsp_5   pnsp;   
label define pnsp    
	0           "Not a sample person this month"
	999         "Not applicable"                
;
label values pnpt_1   pnpt;   
label values pnpt_2   pnpt;   
label values pnpt_3   pnpt;   
label values pnpt_4   pnpt;   
label values pnpt_5   pnpt;   
label define pnpt    
	0           "Not a sample person this month"
	999         "Not applicable"                
;
...
label define u_srvdtk
	...
	9           "Not answered"                  
;
label values u_srvdt3 u_srvdtl;
label define u_srvdtl
	0           "Not applicable"                
	1           "Vietnam era (Aug 64-Apr 75)"   
	2           "Korean Conflict (June 50-Jan 55)"
	3           "World War II (Sept 40-July 47)"
...
label define caidcov 
	...
	2           "No"                            
;
label values caidmth1 caidmthv;
label define caidmthv
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
label values caidmth2 caidmthk;
label define caidmthk
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
label values caidmth3 caidmthl;
label define caidmthl
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
label values caidmth4 caidmthm;
label define caidmthm
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
...
label define ws2_211k
	...
	2           "No"                            
;
label values ws2_2123 ws2_212d;
label define ws2_212d
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to WS2-2125"         
;
label values ws2_2124 ws2_212k;
label define ws2_212k
	...
	6           "Quit for some other reason"    
;
label values ws2_2125 ws2_212l;
...
label define ws2_212n
	0           "Not in universe"               
;
label values ws2_2129 ws2_212o;
...
label define se2cal0m
	...
	2           "No imputed input"              
;
label values i01recip i01recip;
label define i01recip
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
...
label define i01amt4l
	-0009       "Not in universe"               
;
label values kidssyn1 kidssynp;
label define kidssynp
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
...
label define kidssynm
	...
	2           "No"                            
;
label values kdssamt1 kdssamtp;
label define kdssamtp
	-009        "Not in universe"               
;
...
label define tm8240l 
	0           "Not applicable"                
	1           "Never had any regular arrange-"
;
...
label define tm8306l 
	0           "Not applicable"                
	1           "Court-ordered agreement"       
	2           "Other type of agreement"       
;
...
label define tm8314l 
	...
	2           "Through a court"               
	3           "Through the welfare agency"    
	4           "Some other method"             
;
label values tm8316   tm8316l;
label define tm8316l 
	0           "Not applicable"                
	1           "Yes - skip to TM8320"          
	2           "No"                            
;
label values tm8318   tm8318l;
label define tm8318l 
	0           "Not applicable"                
	1           "Child (children) over the"     
	2           "Other parent deceased -"       
	3           "Other parent not working -"    
	4           "Other - skip to TM8334"        
;
...
label define tm8334l 
	0           "Not applicable"                
	1           "Visitation arrangements with"  
	2           "Shared living arrangements"    
	3           "Other arrangements"            
	4           "No custody arrangements"       
;
...
label define tm8336l 
	...
	1           "Yes"                           
	2           "No"                            
	3           "Other parent deceased -"       
;
label values tm8338   tm8338l;
label define tm8338l 
	0           "Not applicable"                
	1           "Yes"                           
	2           "No - skip to Check Item T14"   
	-1          "DK - skip to Check Item T14"   
;
...
label define tm8598l 
	-1          "Dk - skip to Check Item T17"   
	0           "Not applicable"                
	1           "Yes"                           
	2           "No - skip to Check Item T17"   
;
...
label define tm8822l 
	0           "Not applicable"                
	1           "Surgery or operation (including"
;
...
label define tm8830l 
	-3          "None - skip to TM8834"         
	-1          "Don't know - skip to TM8834"   
	0           "Not applicable"                
;
...
label define tm8844l 
	...
	5           "Dissatisfied with previous"    
	6           "Don't believe in health"       
	7           "Have been healthy, not much"   
	8           "Able to go to VA or military"  
	9           "Covered by some other health"  
	10          "Other"                         
;
...
label define tm8904l 
	0           "Not applicable"                
	1           "Yes - mark 1c(TM8906) through" 
	2           "No - ask 1c through 1e"        
;
