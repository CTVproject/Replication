log using sip87rt2, text replace
set mem 1000m
*This program reads the 1987 SIPP Wave 2 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:17:33 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip87rt2
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1987\sip87rt2.dat"
...
clear
quietly infile using "${extractcodedir}\sip87rt2"
...
label define u1totvst
	-9          "Not answered"                  
	0           "Not applicable"                
	99          "Total number of personal visits"
;
...
label define sc1237l 
	0           "Not marked as a month with weeks"
;
...
label define imw_822p
	...
	1           "Imputed"                       
;
label values imp_8224 imp_822p;
...
label define imp_822k
	...
	1           "Imputed"                       
;
label values imp_8228 imp_822l;
...
label define imp_823l
	...
	1           "Imputed"                       
;
label values imp_8240 imp_824p;
...
label define imp_824k
	...
	1           "Imputed"                       
;
label values imp_8246 imp_824l;
label define imp_824l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values imp_8248 imp_824m;
...
label define imp_825p
	...
	1           "Imputed"                       
;
label values imp_8266 imp_826p;
...
label define imp_827p
	...
	1           "Imputed"                       
;
label values imp_8274 imp_827k;
label define imp_827k
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values imp_8276 imp_827l;
label define imp_827l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values imp_8278 imp_827m;
label define imp_827m
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values imp_8290 imp_829p;
label define imp_829p
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define imp_occ 
	...
	1           "Imputed"                       
;
label values imp_8272 imp_827c;
label define imp_827c
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values imp_8282 imp_828c;
label define imp_828c
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values imp_8288 imp_828k;
label define imp_828k
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values asg_8244 asg_824c;
label define asg_824c
	0           "Not assigned"                  
	1           "Assigned"                      
;
label values asg_8252 asg_825c;
label define asg_825c
	0           "Not assigned"                  
	1           "Assigned"                      
;
label values asg_8286 asg_828c;
label define asg_828c
	0           "Not assigned"                  
	1           "Assigned"                      
;
...
;
label values fafm2    fafm2l; 
label define fafm2l  
	0           "No pass; see FAFM"             
	1           "FAFM shown to be a 1 whether"  
;
...
label define falm    
	...
	3           "Year and/or month was not"     
;
label values falm2    falm2l; 
label define falm2l  
	0           "No second pass; see FALM"      
	1           "Second pass made; see spouse's"
;
...
label define tm9690l 
	0           "Not in universe"               
;
label values u_tm9266 u_tm926a;
label define u_tm926a
	0           "Not in universe"               
	...
	4           "Other"                         
;
label values u_tm9300 u_tm930a;
label define u_tm930a
	0           "Not in universe"               
;
label values u_tm9330 u_tm933a;
label define u_tm933a
	0           "Not in universe"               
;
...
label define u_tm933k
	...
	99          "No response"                   
;
label values u_tm9360 u_tm936a;
label define u_tm936a
	0           "Not in universe"               
;
label values u_tm9390 u_tm939a;
label define u_tm939a
	0           "Not in universe"               
;
label values u_tm9420 u_tm942a;
label define u_tm942a
	0           "Not in universe"               
;
label values u_tm9450 u_tm945a;
label define u_tm945a
	0           "Not in universe"               
;
label values u_tm9480 u_tm948a;
label define u_tm948a
	0           "Not in universe"               
;
label values u_tm9510 u_tm951a;
label define u_tm951a
	0           "Not in universe"               
;
label values u_tm9540 u_tm954a;
label define u_tm954a
	0           "Not in universe"               
;
label values u_tm9570 u_tm957a;
label define u_tm957a
	0           "Not in universe"               
;
label values u_tm9600 u_tm960a;
label define u_tm960a
	0           "Not in universe"               
;
label values u_tm9630 u_tm963a;
label define u_tm963a
	0           "Not in universe"               
;
label values u_tm9660 u_tm966a;
label define u_tm966a
	0           "Not in universe"               
;
label values u_tm9690 u_tm969a;
label define u_tm969a
	0           "Not in universe"               
;
