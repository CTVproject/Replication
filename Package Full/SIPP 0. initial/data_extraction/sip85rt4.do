log using sip85rt4, text replace
set mem 1000m
*This program reads the 1985 SIPP Wave 4 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:32:58 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip85rt4
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1985\sip85rt4.dat"
...
clear
quietly infile using "${extractcodedir}\sip85rt4"
...
label define u_hhmem 
	...
	2           "No"                            
;
label values uentlft1 uentlftm;
label define uentlftm
...
label define tm8690l 
	0           "NOT IN UNIVERSE"               
;
label values u_tm8266 u_tm826e;
label define u_tm826e
	0           "NOT IN UNIVERSE"               
	1           "ONE PERSON HH - SKIP TO SC6000"
	2           "TWO PERSON HH CONSISTING OF HUS-"
	3           "TWO PERSON HH CONSISTING OF"   
...
;
label values u_tm8300 u_tm830e;
label define u_tm830e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8330 u_tm833e;
label define u_tm833e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8360 u_tm836e;
label define u_tm836e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8390 u_tm839e;
label define u_tm839e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8420 u_tm842e;
label define u_tm842e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8450 u_tm845e;
label define u_tm845e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8480 u_tm848e;
label define u_tm848e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8510 u_tm851e;
label define u_tm851e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8540 u_tm854e;
label define u_tm854e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8570 u_tm857e;
label define u_tm857e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8600 u_tm860e;
label define u_tm860e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8630 u_tm863e;
label define u_tm863e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8660 u_tm866e;
label define u_tm866e
	0           "NOT IN UNIVERSE"               
;
label values u_tm8690 u_tm869e;
label define u_tm869e
	0           "NOT IN UNIVERSE"               
;
...
label define tm8062l 
	...
	1           "AMOUNT PAID"                   
;
label values tm8_imp1 tm8_impe;
label define tm8_impe
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
...
label define tm8_impm
	...
	1           "IMPUTED"                       
;
label values tm8_imp5 tm8_impn;
label define tm8_impn
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8_imp6 tm8_impo;
label define tm8_impo
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8_imp7 tm8_impp;
label define tm8_impp
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8_imp8 tm8_impq;
label define tm8_impq
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8_imp9 tm8_impr;
label define tm8_impr
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp10 tm8imp1e;
label define tm8imp1e
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
...
label define tm8imp1m
	...
	1           "IMPUTED"                       
;
label values tm8imp14 tm8imp1n;
label define tm8imp1n
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp15 tm8imp1o;
label define tm8imp1o
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp16 tm8imp1p;
label define tm8imp1p
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp17 tm8imp1q;
label define tm8imp1q
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp18 tm8imp1r;
label define tm8imp1r
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp19 tm8imp1s;
label define tm8imp1s
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp20 tm8imp2e;
label define tm8imp2e
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
...
label define tm8imp2m
	...
	1           "IMPUTED"                       
;
label values tm8imp24 tm8imp2n;
label define tm8imp2n
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp25 tm8imp2o;
label define tm8imp2o
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tm8imp26 tm8imp2p;
