log using sip86rt3, text replace
set mem 1000m
*This program reads the 1986 SIPP Wave 3 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:28:23 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip86rt3
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1986\sip86rt3.dat"
...
clear
quietly infile using "${extractcodedir}\sip86rt3"
...
label define u_entlfm
	...
	37          "Entered - from Armed Forces barracks"
	38          "Entered - from outside the country"
	39          "Entered - due to separation or"
	99          "Interviewed in previous wave but"
;
...
label define u_entlfk
	...
	38          "Entered - from outside the country"
	39          "Entered - due to separation or"
	99          "Interviewed in previous wave"  
;
...
label define tm8002l 
	0           "Not applicable"                
	1           "Yes - skip to TM8004"          
	2           "No"                            
;
label values tm8003   tm8003l;
label define tm8003l 
	0           "Not applicable"                
	1           "Yes"                           
	2           "No - skip to TM8056"           
;
...
label define tm8034l 
	...
	2           "Child's brother/sister 15+"    
	3           "Child's brother/sister under"  
	4           "Child's grandparent"           
	5           "Other relative of child"       
	6           "Nonrelative of child"          
	7           "Child in day/group care"       
	...
	10          "Child cares for self"          
	11          "Works at home"                 
	12          "Cares for child at work (in class)"
;
...
label define tm8050l 
	-1          "DK"                            
	-999999     "Weekly child care expense"     
	0           "Not applicable"                
;
...
label define tm8082l 
	...
	1           "Yes"                           
	2           "No - skip to TM8088"           
	3           "Father deceased - skip to TM8092"
;
...
label define tm8336l 
	...
	7           "Health center (neighborhood health"
	8           "Other"                         
;
...
label define tm8342l 
	0           "Not applicable"                
	1           "Correct"                       
	2           "Incorrect - covered by"        
	3           "Incorrect - covered by"        
	4           "Some other plan - skip to TM8400"
;
...
label define tm8344l 
	...
	3           "Can't obtain health insurance because"
	4           "Too expensive, can't afford health"
	5           "Dissatisfied with previous health"
	6           "Don't believe in health insurance"
	7           "Have been healthy, not much sickness"
	8           "Able to go to VA or military hospital"
	9           "Covered by some other health plan"
	10          "Other"                         
;
...
label define tm8462l 
	0           "Not applicable"                
	1           "Unable to leave the house - skip"
	2           "Yes"                           
	3           "No - skip to TM8480"           
;
...
label define tm8618l 
	0           "Not applicable"                
	1           "Yes - ask TM8620 thru 8630 for each"
	2           "No - skip to check item M1"    
;
