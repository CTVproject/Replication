log using sip90w6, text replace
set mem 1000m
*This program reads the 1990 SIPP Wave 6 Core Data File 
*Note:  This program is distributed under the GNU GPL. See end of
*this file and http://www.gnu.org/licenses/ for details.
*by Jean Roth Mon Jun  7 17:37:05 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip90w6
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1990\sip90w6.dat"
...
clear
quietly infile using "${extractcodedir}\sip90w6"
...
label define fnssr   
	0           "None"                          
;
label values fssunit  fssunit;
label define fssunit 
