log using sip84w2, text replace
set mem 1000m

/*------------------------------------------------

  This program reads the 1984 SIPP Wave 2 Core Data File 
...
****************************************************************
  ...
  by Jean Roth Mon Apr 17 09:09:30 EDT 2006
...
local dat_name "sipp84w2.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "sipp84w2.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "${extractcodedir}\sip84w2.dct"
