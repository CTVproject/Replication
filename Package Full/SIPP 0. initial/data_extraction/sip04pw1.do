log using sip04w1, text replace
set mem 1000m

/*------------------------------------------------

  This program reads the 2004 SIPP Wave 1 Core Data File 
  Note:  This program is distributed under the GNU GPL. See end of
  this file and http://www.gnu.org/licenses/ for details.
  by Jean Roth Mon Apr 10 14:44:24 EDT 2006
...
local dat_name "sipp04pw1.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "./sipp04pw1.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "./sip04pw1.dct"
...
label define rcutyp5k
	9           "Suppressed when age <15 in any"
	1           "Yes, covered"                  
	2           "No, not covered"               
;
...
label define eeducate
	...
	40          "Some college credit, but no degree"
...
label define rmesr   
	...
	3           "With a job all month, absent from"
...
label define aclthsc 
	...
	4           "Statistical or logical imputation"
;
label values epahstyp epahstyp;
label define epahstyp
	1           "Section 8"                     
	...
	-1          "Not in universe"               
;
label values apahstyp apahstyp;
label define apahstyp
	0           "Not imputed"                   
	1           "Statistical imputation (hot deck)"
	2           "Cold deck imputation"          
	3           "Logical imputation (derivation)"
...
label define ras21l  
	0           "No occurrence of second stopping"
	1           "Got a job or earnings increased"
	2           "Family situation changed"      
	3           "Others in household earned enough"
	4           "Penalized or sanctioned for"   
