log using sip87rt7, text replace
set mem 1000m
*This program reads the 1987 SIPP Wave 7 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:21:45 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip87rt7
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1987\sip87rt7.dat"
...
clear
quietly infile using "${extractcodedir}\sip87rt7"
...
label define tm8530l 
	...
	2           "Rented for cash - skip to TM8538"
...
label define tm8770l 
	0           "Not marked as a kind of vehicle"
