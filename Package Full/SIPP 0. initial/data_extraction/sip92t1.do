log using sip92t1, text replace
set mem 1000m
...
clear
quietly infile using "${extractcodedir}\sip92t1"
...
label define tm3000l 
	...
	178         "Perkins Loans or National Direct"
	179         "Stafford Loan or Guaranteed"   
	180         "Parent Loan for Undergraduate" 
	181         "Assistance from employer"      
...
label define tm8278l 
	0           "Not in universe or less than"  
;
