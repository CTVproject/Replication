log using sip88rt2, text replace
set mem 1000m
*This program reads the 1988 SIPP Wave 2 Rectangular and Topical Data File 
...
*by Jean Roth Thu Aug 18 17:05:47 EDT 2005
*Please report errors to jroth@nber.org
*run with do sip88rt2
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1988\sip88rt2.dat"
...
clear
quietly infile using "${extractcodedir}\sip88rt2"
...
label define h1_int1l
	0           "Sample household added in Wave 2"
	1           "Interviewed"                   
	2           "No one home"                   
...
label define h2_imp0l
	...
	1           "Imputed"                       
;
label values h2_imp06 h2_imp0m;
label define h2_imp0m
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h2_imp07 h2_imp0n;
label define h2_imp0n
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h2_imp08 h2_imp0o;
label define h2_imp0o
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h2_imp09 h2_imp0p;
...
label define h3_imp0l
	...
	1           "Imputed"                       
;
label values h3_imp06 h3_imp0m;
label define h3_imp0m
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h3_imp07 h3_imp0n;
label define h3_imp0n
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h3_imp08 h3_imp0o;
label define h3_imp0o
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h3_imp09 h3_imp0p;
...
label define h4_imp0l
	...
	1           "Imputed"                       
;
label values h4_imp06 h4_imp0m;
label define h4_imp0m
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h4_imp07 h4_imp0n;
label define h4_imp0n
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h4_imp08 h4_imp0o;
label define h4_imp0o
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values h4_imp09 h4_imp0p;
...
label define pw_rrp  
	...
	3           "Husband/wife or reference person"
	4           "Natural/adopted child of"      
	5           "Step child of reference person"
	6           "Foster child of reference"     
	7           "Grand child of reference person"
...
label define u_monlft
	0           "Not applicable (person did not"
;
...
label define u_vet   
	...
	9           "Not answered"                  
;
label values u_srvdt1 u_srvdtt;
label define u_srvdtt
	0           "Not applicable"                
	...
	9           "Not answered"                  
;
label values u_srvdt2 u_srvdtk;
label define u_srvdtk
	0           "Not applicable"                
	1           "Vietnam era (Aug 64-Apr 75)"   
	2           "Korean Conflict (June 50-Jan 55)"
	3           "World War II (Sept 40-July 47)"
	...
	9           "Not answered"                  
;
label values u_srvt3  u_srvt3l;
label define u_srvt3l
	0           "Not applicable"                
	1           "Vietnam era (Aug 64-Apr 75)"   
	2           "Korean Conflict (June 50-Jan 55)"
	3           "World War II (Sept 40-July 47)"
...
label define champ   
	...
	2           "No"                            
;
label values champmth champmth;
label define champmth
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
...
label define railrd4l
	...
	2           "No"                            
;
label values it7a1    it7a1l; 
label define it7a1l  
	0           "Not answered"                  
	1           "Self"                          
	2           "Proxy"                         
;
label values it7b     it7b;   
label define it7b    
	0           "Not answered"                  
	1           "Type Z refusal"                
	2           "Type Z other"                  
...
label define sc1048l 
	0           "Not marked as a month ... did" 
	1           "Marked a a month ... did that" 
;
label values sc1050   sc1050l;
label define sc1050l 
	0           "Not marked as a month ... did" 
	1           "Marked as a month ... did that"
;
...
label define sc1054l 
	...
	1           "Marked a a month ... did that" 
;
label values sc1055   sc1055l;
label define sc1055l 
	0           "Not in universe"               
	1           "Yes - skip to SC1240"          
	2           "No - skip to SC1248"           
;
...
label define sc1244l 
	0           "Not in universe"               
	1           "Yes"                           
	2           "No skip to SC1330 Wave 1 and"  
;
...
label define sc1348l 
	...
	2           "No - skip to SC1354"           
;
label values sc1349   sc1349l;
label define sc1349l 
	0           "Not in universe"               
;
...
label define medcode 
	...
	2           "Spouse or retired or disabled" 
...
label define sc1468l 
	...
	4           "Card not available - ask SC1470"
;
...
;
label values sc1481   sc1481l;
label define sc1481l 
	0           "Not in Universe"               
	1           "Yes - skip to SC1484"          
	2           "No"                            
;
...
label define sc1484l 
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SC1502 - Wave 1 and"
;
...
label define sc1546l 
	...
	1           "Marked as a month with the plan"
;
label values sc1547   sc1547l;
label define sc1547l 
	0           "Not in universe"               
	1           "Plan in own name - skip to"    
	2           "Someone else's plan"           
	3           "Both - skip tp SC1549"         
;
label values sc1548   sc1548l;
label define sc1548l 
	-04         "Not a household member -"      
	0           "Not in universe"               
;
label values sc1549   sc1549l;
label define sc1549l 
	1           "Current employer or union"     
	2           "Former employer"               
	3           "CHAMPUS - Skip to SC1552"      
	4           "CHAMPVA - Skip to SC1552"      
	5           "Military - Skip to SC1552"     
	6           "Other - Skip to SC1552"        
;
...
label define sc1566l 
	...
	0           "Not in universe"               
;
label values sc1567   sc1567l;
label define sc1567l 
	0           "Not marked"                    
	1           "Marked"                        
;
...
label define sc1568l 
	...
	1           "Marked"                        
;
label values sc1569   sc1569l;
label define sc1569l 
	0           "Not marked"                    
	1           "Marked"                        
;
...
label define sc1572l 
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SC1624 - Wave 1 and"
;
label values sc1574   sc1574l;
label define sc1574l 
	0           "Not in universe"               
	1           "Yes - skip to SC1581"          
	2           "No"                            
;
label values sc1575   sc1575l;
label define sc1575l 
	0           "Not in universe"               
;
...
label define sc1576l 
	0           "Not in universe"               
;
label values sc1577   sc1577l;
label define sc1577l 
	0           "Not in universe"               
;
...
label define sc1578l 
	0           "Not in universe"               
;
label values sc1579   sc1579l;
label define sc1579l 
	0           "Not in universe"               
;
label values sc1580   sc1580l;
label define sc1580l 
	-3          "None - skip to SC1624 - Wave 1"
	0           "Not in universe"               
;
label values sc1581   sc1581l;
label define sc1581l 
	0           "Not in universe"               
	1           "Yes"                           
;
...
label define sc1582l 
	0           "Not in universe"               
;
label values sc1583   sc1583l;
label define sc1583l 
	0           "Not in universe"               
;
...
label define sc1584l 
	0           "Not in universe"               
;
label values sc1585   sc1585l;
label define sc1585l 
	0           "Not in universe"               
;
...
label define sc1586l 
	0           "Not in universe"               
;
label values sc1587   sc1587l;
label define sc1587l 
	0           "Not in universe"               
	2           "No"                            
;
...
label define sc1668l 
	0           "Not in universe"               
	1           "Elementary grades 1-8 - skip"  
	2           "High school grades 9-12 - skip"
	3           "College year 1"                
	4           "College year 2"                
	5           "College year 3"                
	6           "College year 4"                
...
label define ws1_200d
	0           "Not in universe"               
;
label values ws1_2003 ws1_200k;
label define ws1_200k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values ws1_2004 ws1_200l;
label define ws1_200l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to WS1-2014"         
;
...
label define ws1_202k
	0           "Not in universe"               
;
label values ws1_2023 ws1_202l;
label define ws1_202l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to WS1-2025"         
;
label values ws1_2024 ws1_202m;
...
;
label values ws1_2025 ws1_202n;
label define ws1_202n
	-3          "None"                          
	0           "Not in universe"               
;
label values ws1_2026 ws1_202o;
label define ws1_202o
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to WS1-2029"         
;
label values ws1_2028 ws1_202p;
label define ws1_202p
	0           "Not in universe"               
;
label values ws1_2029 ws1_202q;
label define ws1_202q
	0           "Not in universe"               
	1           "Once a week"                   
	2           "Once each 2 weeks"             
	3           "Once a month"                  
	4           "Unpaid in family business or"  
	5           "Some other way"                
;
label values ws1_2030 ws1_203d;
label define ws1_203d
	-4          "Not paid during reference"     
	0           "Not in universe"               
;
label values ws1_2031 ws1_203k;
label define ws1_203k
	-4          "Not paid during reference"     
	0           "Not in universe"               
;
label values ws1_2032 ws1_203l;
label define ws1_203l
	0           "Not in universe"               
	-3          "None"                          
;
label values ws1_2034 ws1_203m;
label define ws1_203m
	0           "Not in universe"               
	-3          "None"                          
;
label values ws1_2036 ws1_203n;
label define ws1_203n
	0           "Not in universe"               
	-3          "None"                          
;
label values ws1_2038 ws1_203o;
label define ws1_203o
	0           "Not in universe"               
	-3          "None"                          
;
...
label define ws1_204k
	...
	2           "No"                            
;
label values ws1_2044 ws1_204l;
label define ws1_204l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values ws1_2046 ws1_204m;
label define ws1_204m
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
...
label define ws1imp0o
	...
	1           "Imputed"                       
;
label values ws1imp07 ws1imp0p;
label define ws1imp0p
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws1imp08 ws1imp0q;
label define ws1imp0q
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws1imp09 ws1imp0r;
label define ws1imp0r
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws1imp10 ws1imp1d;
label define ws1imp1d
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws1imp11 ws1imp1k;
label define ws1imp1k
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define ws2_amtm
	-0009       "Not in universe"               
;
label values ws2_2102 ws2_210d;
label define ws2_210d
	0           "Not in universe"               
;
label values ws2_2103 ws2_210k;
label define ws2_210k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values ws2_2104 ws2_210l;
label define ws2_210l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
...
label define ws2_212k
	0           "Not in universe"               
;
label values ws2_2123 ws2_212l;
label define ws2_212l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to WS2-2125"         
;
label values ws2_2124 ws2_212m;
label define ws2_212m
	...
	6           "Quit for some other reason"    
;
label values ws2_2125 ws2_212n;
label define ws2_212n
	0           "Not in universe"               
	-3          "None"                          
;
label values ws2_2126 ws2_212o;
label define ws2_212o
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to WS2-2129"         
;
label values ws2_2128 ws2_212p;
label define ws2_212p
	0           "Not in universe"               
;
label values ws2_2129 ws2_212q;
label define ws2_212q
	0           "Not in universe"               
	1           "Once a week"                   
	2           "Once each 2 weeks"             
	3           "Once a month"                  
...
label define ws2_213d
	...
	-4          "Not paid during reference"     
;
label values ws2_2131 ws2_213k;
label define ws2_213k
	0           "Not in universe"               
	-4          "Not paid during reference"     
;
label values ws2_2132 ws2_213l;
label define ws2_213l
	0           "Not in universe"               
	-3          "None"                          
;
label values ws2_2134 ws2_213m;
label define ws2_213m
	0           "Not in universe"               
	-3          "None"                          
;
label values ws2_2136 ws2_213n;
label define ws2_213n
	0           "Not in universe"               
	-3          "None"                          
;
label values ws2_2138 ws2_213o;
label define ws2_213o
	0           "Not in universe"               
	-3          "None"                          
;
...
label define ws2_214k
	...
	2           "No"                            
;
label values ws2_2144 ws2_214l;
label define ws2_214l
	0           "Not in universe"               
	2           "No"                            
;
label values ws2_2146 ws2_214m;
label define ws2_214m
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
...
label define ws2imp0o
	...
	1           "Imputed"                       
;
label values ws2imp07 ws2imp0p;
label define ws2imp0p
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws2imp08 ws2imp0q;
label define ws2imp0q
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws2imp09 ws2imp0r;
label define ws2imp0r
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws2imp10 ws2imp1d;
label define ws2imp1d
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws2imp11 ws2imp1k;
label define ws2imp1k
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
;
label values se1_wks1 se1_wksr;
label define se1_wksr
	0           "None"                          
	1           "1 week"                        
	2           "2 weeks"                       
	3           "3 weeks"                       
	...
	9           "Not in universe"               
;
label values se1_wks2 se1_wksk;
label define se1_wksk
	0           "None"                          
	1           "1 week"                        
	2           "2 weeks"                       
	3           "3 weeks"                       
	...
	9           "Not in universe"               
;
label values se1_wks3 se1_wksl;
label define se1_wksl
	0           "None"                          
	1           "1 week"                        
	2           "2 weeks"                       
	3           "3 weeks"                       
	...
	9           "Not in universe"               
;
label values se1_wks4 se1_wksm;
label define se1_wksm
	0           "None"                          
	1           "1 week"                        
	2           "2 weeks"                       
	3           "3 weeks"                       
	...
	9           "Not in universe"               
;
label values se1_rec1 se1_recr;
label define se1_recr
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_rec2 se1_reck;
label define se1_reck
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_rec3 se1_recl;
label define se1_recl
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_rec4 se1_recm;
label define se1_recm
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_amt1 se1_amtr;
label define se1_amtr
	-0009       "Not in universe"               
;
label values se1_amt2 se1_amtk;
label define se1_amtk
	-0009       "Not in universe"               
;
label values se1_amt3 se1_amtl;
label define se1_amtl
	-0009       "Not in universe"               
;
label values se1_amt4 se1_amtm;
label define se1_amtm
	-0009       "Not in universe"               
;
label values se1_2201 se1_220r;
label define se1_220r
	0           "Not answered"                  
	-9          "Not in universe"               
;
label values se1_2202 se1_220k;
label define se1_220k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_2203 se1_220l;
label define se1_220l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_2212 se1_221r;
label define se1_221r
	0           "Not in universe"               
	-3          "None"                          
;
label values se1_2214 se1_221k;
label define se1_221k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SE1-2260"         
;
label values se1_2216 se1_221l;
label define se1_221l
	0           "Not in universe"               
	1           "Yes - skip to SE1-2232"        
	2           "No"                            
;
label values se1_2218 se1_221m;
label define se1_221m
	0           "Not in universe"               
	3           "3 - 5 employees"               
	4           "6 or more employees"           
;
label values se1_2220 se1_222r;
label define se1_222r
	0           "Not in universe"               
	1           "Yes - skip to SE1-2224"        
	2           "No"                            
;
label values se1_2222 se1_222k;
label define se1_222k
	0           "Not in universe"               
	1           "Sole proprietorship - skip to" 
	2           "Partnership"                   
;
label values se1_2224 se1_222l;
label define se1_222l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SE1-2232"         
;
label values se1_2226 se1_222m;
label define se1_222m
	0           "Not in universe"               
;
label values se1_2228 se1_222n;
label define se1_222n
	0           "Not in universe"               
;
label values se1_2230 se1_223r;
label define se1_223r
	0           "Not in universe"               
;
label values se1_2232 se1_223k;
label define se1_223k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_2234 se1_223l;
label define se1_223l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_2236 se1_223m;
label define se1_223m
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SE1-2250"         
;
label values se1_2238 se1_223n;
label define se1_223n
	0           "None"                          
	-3          "Not in universe"               
;
label values se1_2240 se1_224r;
label define se1_224r
	0           "None"                          
	-3          "Not in universe"               
;
label values se1_2242 se1_224k;
label define se1_224k
	0           "None"                          
	-3          "Not in universe"               
;
label values se1_2244 se1_224l;
label define se1_224l
	0           "None"                          
	-3          "Not in universe"               
;
label values se1_2246 se1_224m;
label define se1_224m
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SE1-2250"         
;
label values se1_2248 se1_224n;
label define se1_224n
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_2250 se1_225r;
label define se1_225r
	0           "Not in universe"               
	1           "Yes - skip to SE1-2262"        
	2           "No"                            
;
label values se1_2252 se1_225k;
label define se1_225k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_2254 se1_225l;
label define se1_225l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se1_2256 se1_225m;
label define se1_225m
	0           "Not in universe"               
;
label values se1_2260 se1_226r;
label define se1_226r
	0           "None"                          
	-3          "Not in universe"               
;
...
label define se1cal0m
	...
	2           "No imputed input"              
;
label values se2_occ  se2_occ;
label define se2_occ 
	0           "Not in universe"               
;
...
label define se2_indr
	...
	16          "Industry not reported (990)"   
;
label values se2_wks1 se2_wksr;
label define se2_wksr
	0           "None"                          
	1           "1 week"                        
	2           "2 weeks"                       
	3           "3 weeks"                       
	...
	9           "Not in universe"               
;
label values se2_wks2 se2_wksk;
label define se2_wksk
	0           "None"                          
	1           "1 week"                        
	2           "2 weeks"                       
	3           "3 weeks"                       
	...
	9           "Not in universe"               
;
label values se2_wks3 se2_wksl;
label define se2_wksl
	0           "None"                          
	1           "1 week"                        
	2           "2 weeks"                       
	3           "3 weeks"                       
	...
	9           "Not in universe"               
;
label values se2_wks4 se2_wksm;
label define se2_wksm
	0           "None"                          
	1           "1 week"                        
	2           "2 weeks"                       
	3           "3 weeks"                       
	...
	9           "Not in universe"               
;
label values se2_rec1 se2_recr;
label define se2_recr
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_rec2 se2_reck;
label define se2_reck
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_rec3 se2_recl;
label define se2_recl
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_rec4 se2_recm;
label define se2_recm
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_amt1 se2_amtr;
label define se2_amtr
	-0009       "Not in universe"               
;
label values se2_amt2 se2_amtk;
label define se2_amtk
	-0009       "Not in universe"               
;
label values se2_amt3 se2_amtl;
label define se2_amtl
	-0009       "Not in universe"               
;
label values se2_amt4 se2_amtm;
label define se2_amtm
	-0009       "Not in universe"               
;
label values se2_2301 se2_230r;
label define se2_230r
	-9          "Not in universe"               
	0           "Not answered"                  
;
label values se2_2302 se2_230k;
label define se2_230k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_2303 se2_230l;
label define se2_230l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_2312 se2_231r;
label define se2_231r
	-3          "None"                          
	0           "Not in universe"               
;
label values se2_2314 se2_231k;
label define se2_231k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SE2-2360"         
;
label values se2_2316 se2_231l;
label define se2_231l
	0           "Not in universe"               
	1           "Yes - skip to SE2-2332"        
	2           "No"                            
;
label values se2_2318 se2_231m;
label define se2_231m
	0           "Not in universe"               
	3           "3 - 5 employees"               
	4           "6 or more employees"           
;
label values se2_2320 se2_232r;
label define se2_232r
	0           "Not in universe"               
	1           "Yes - skip to SE2-2324"        
	2           "No"                            
;
label values se2_2322 se2_232k;
label define se2_232k
	0           "Not in universe"               
	1           "Sole proprietorship - skip to" 
	2           "Partnership"                   
;
label values se2_2324 se2_232l;
label define se2_232l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SE2-2332"         
;
label values se2_2326 se2_232m;
label define se2_232m
	0           "Not in universe"               
;
label values se2_2328 se2_232n;
label define se2_232n
	0           "Not in universe"               
;
label values se2_2330 se2_233r;
label define se2_233r
	0           "Not in universe"               
;
label values se2_2332 se2_233k;
label define se2_233k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_2334 se2_233l;
label define se2_233l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_2336 se2_233m;
label define se2_233m
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SE2-2350"         
;
label values se2_2338 se2_233n;
label define se2_233n
	0           "None"                          
	-3          "Not in universe"               
;
label values se2_2340 se2_234r;
label define se2_234r
	0           "None"                          
	-3          "Not in universe"               
;
label values se2_2342 se2_234k;
label define se2_234k
	0           "None"                          
	-3          "Not in universe"               
;
label values se2_2344 se2_234l;
label define se2_234l
	0           "None"                          
	-3          "Not in universe"               
;
label values se2_2346 se2_234m;
label define se2_234m
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SE2-2350"         
;
label values se2_2348 se2_234n;
label define se2_234n
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_2350 se2_235r;
label define se2_235r
	0           "Not in universe"               
	1           "Yes - skip to SE2-2362"        
	2           "No"                            
;
label values se2_2352 se2_235k;
label define se2_235k
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_2354 se2_235l;
label define se2_235l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values se2_2356 se2_235m;
label define se2_235m
	0           "Not in universe"               
;
label values se2_2360 se2_236r;
label define se2_236r
	0           "None"                          
	-3          "Not in universe"               
;
...
label define ss3014l 
	...
	2           "No"                            
;
label values ss3062   ss3062l;
label define ss3062l 
	0           "Not in universe"               
	1           "Yes - skip to RR3068"          
	2           "No"                            
;
...
label define rr3014l 
	...
	2           "No"                            
;
label values rr3062   rr3062l;
label define rr3062l 
	0           "Not in universe"               
	1           "Yes - skip to RR3068"          
	2           "No"                            
;
...
label define vet3054l
	0           "Not in universe"               
;
label values vet3058  vet3058l;
label define vet3058l
	0           "Not in universe"               
...
label define i08imp0m
	...
	1           "Imputed"                       
;
label values i08imp05 i08imp0n;
label define i08imp0n
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define wic3144l
	...
	9           "Not in universe"               
;
label values wic3146  wic3146l;
label define wic3146l
	0           "Not in universe"               
;
label values wic3148  wic3148l;
label define wic3148l
	0           "Not in universe"               
;
label values wic3150  wic3150l;
label define wic3150l
	0           "Not in universe"               
;
label values wic3152  wic3152l;
label define wic3152l
	0           "Not in universe"               
;
label values wic3154  wic3154l;
label define wic3154l
	0           "Not in universe"               
;
...
label define i40imp0m
	...
	1           "Imputed"                       
;
label values i41rec1  i41rec1l;
label define i41rec1l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values i41rec2  i41rec2l;
label define i41rec2l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values i41rec3  i41rec3l;
label define i41rec3l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values i41rec4  i41rec4l;
label define i41rec4l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
...
label define i41amt4l
	-0009       "Not in universe"               
;
label values i41imp01 i41imp0d;
label define i41imp0d
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values i41imp02 i41imp0k;
label define i41imp0k
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values i41imp03 i41imp0l;
label define i41imp0l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values i41imp04 i41imp0m;
label define i41imp0m
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define jcalc10d
	...
	9           "Not in universe"               
;
label values jcalb100 jcalb10d;
label define jcalb10d
	0           "No, not calculated"            
...
label define ocalc10d
	...
	9           "Not in universe"               
;
label values ocalb100 ocalb10d;
label define ocalb10d
	0           "No, not calculated"            
	1           "Yes, balance was calculated"   
;
...
label define o4050ynd
	...
	2           "No"                            
;
label values o4050yn2 o4050ynk;
label define o4050ynk
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values o4050yn3 o4050ynl;
label define o4050ynl
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values o4050yn4 o4050ynm;
label define o4050ynm
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
...
label define tm9690l 
	0           "Not in universe"               
;
label values u_tm9266 u_tm926d;
label define u_tm926d
	0           "Not in universe"               
	1           "One person hh - skip to SC5000"
	2           "Two person hh consisting of"   
	3           "Two person hh consisting of"   
	4           "Other"                         
;
label values u_tm9300 u_tm930d;
label define u_tm930d
	0           "Not in universe"               
;
label values u_tm9330 u_tm933d;
label define u_tm933d
	0           "Not in universe"               
;
...
label define u_tm933k
	...
	99          "No response"                   
;
label values u_tm9360 u_tm936d;
label define u_tm936d
	0           "Not in universe"               
;
label values u_tm9390 u_tm939d;
label define u_tm939d
	0           "Not in universe"               
;
label values u_tm9420 u_tm942d;
label define u_tm942d
	0           "Not in universe"               
;
label values u_tm9450 u_tm945d;
label define u_tm945d
	0           "Not in universe"               
;
label values u_tm9480 u_tm948d;
label define u_tm948d
	0           "Not in universe"               
;
label values u_tm9510 u_tm951d;
label define u_tm951d
	0           "Not in universe"               
;
label values u_tm9540 u_tm954d;
label define u_tm954d
	0           "Not in universe"               
;
label values u_tm9570 u_tm957d;
label define u_tm957d
	0           "Not in universe"               
;
label values u_tm9600 u_tm960d;
label define u_tm960d
	0           "Not in universe"               
;
label values u_tm9630 u_tm963d;
label define u_tm963d
	0           "Not in universe"               
;
label values u_tm9660 u_tm966d;
label define u_tm966d
	0           "Not in universe"               
;
label values u_tm9690 u_tm969d;
label define u_tm969d
	0           "Not in universe"               
;
...
label define tm_ifa9l
	...
	1           "Imputed"                       
;
label values tm_ifa10 tm_ifa1d;
label define tm_ifa1d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm_ifa1t
	...
	1           "Imputed"                       
;
label values tm_ifa20 tm_ifa2d;
label define tm_ifa2d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm_ifa2t
	...
	1           "Imputed"                       
;
label values tm_ifa30 tm_ifa3d;
label define tm_ifa3d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm8294l 
	...
	6           "Other"                         
;
label values imp_8218 imp_821d;
label define imp_821d
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values imp_8220 imp_822d;
label define imp_822d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define imp_822m
	...
	1           "Imputed"                       
;
label values imp_8230 imp_823d;
label define imp_823d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define imp_823l
	...
	1           "Imputed"                       
;
label values imp_8240 imp_824d;
label define imp_824d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define imp_824n
	...
	1           "Imputed"                       
;
label values imp_8250 imp_825d;
label define imp_825d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define imp_825k
	...
	1           "Imputed"                       
;
label values imp_8266 imp_826d;
label define imp_826d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define imp_826k
	...
	1           "Imputed"                       
;
label values imp_8270 imp_827d;
label define imp_827d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define imp_827n
	...
	1           "Imputed"                       
;
label values imp_8282 imp_828d;
label define imp_828d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define imp_828l
	...
	1           "Imputed"                       
;
label values imp_8290 imp_829d;
label define imp_829d
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm8550l 
	0           "Not applicable"                
	1           "24 or younger - skip to TM8600"
	2           "65 or older - skip to TM8600"  
	3           "25 to 64 years old"            
;
...
label define tm8562l 
	0           "Not applicable"                
	1           "Both natural parents - skip to"
	2           "Natural mother and stepfather" 
	3           "Natural father and stepmother -"
	4           "Natural mother only parent"    
	5           "Natural father only parent"    
	6           "Other"                         
;
...
label define tm8564l 
	...
	2           "Grandfather"                   
	3           "Some other male"               
	4           "Mother - skip to TM8576"       
	5           "Grandmother - skip to TM8576"  
	6           "Some other female - skip to"   
	7           "Not applicable - skip to TM8600"
;
label values tm8566   tm8566l;
label define tm8566l 
	-1          "Did not have a paying job or"  
	0           "Not applicable"                
;
...
label define tm8582l 
	...
	7           "College 5 or more"             
;
label values imp_8562 imp_856c;
label define imp_856c
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm8644l 
	0           "Not in universe"               
	1           "Married, spouse present - skip to"
	2           "Married, spouse absent - skip to"
	3           "Widowed"                       
	4           "Divorced"                      
...
label define tm8786l 
	...
	9           "In school - skip to TM8790"    
	10          "In correctional facility -"    
	11          "Other - skip to TM8790"        
	12          "Deceased- skip to TM8790"      
	13          "Don't know"                    
;
...
label define tm8798l 
	...
	1           "Resides in this household -"   
	2           "In his/her own household -"    
	3           "With own father - skip to TM8802"
	4           "With own grandparent(s) - skip"
	5           "With adoptive parents - skip"  
	6           "Other relatives - skip to TM8802"
	7           "In foster care/foster family"  
	8           "In an institution (hospital)"  
	9           "In school - skip to TM8802"    
	10          "In correctional facility -"    
	11          "Other - skip to TM8802"        
	12          "Deceased - skip to TM8802"     
	13          "Don't know"                    
;
...
label define tm_fer7l
	...
	1           "Imputed"                       
;
label values tm_fer8  tm_fer8l;
label define tm_fer8l
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm_fer9l
	...
	1           "Imputed"                       
;
label values tm_fer20 tm_fer2k;
label define tm_fer2k
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tm_fer21 tm_fer2m;
label define tm_fer2m
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tm_fer22 tm_fer2n;
label define tm_fer2n
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tm_fer23 tm_fer2o;
label define tm_fer2o
	0           "Not imputed"                   
	1           "Imputed"                       
;
