log using sip90r5, text replace
set mem 1000m
*This program reads the 1990 SIPP Wave 5 Topical Module Research Data File 
*Note:  This program is distributed under the GNU GPL. See end of
*this file and http://www.gnu.org/licenses/ for details.
*by Jean Roth Mon Jun  7 17:39:32 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip90r5
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1990\sip90r5.dat"
...
clear
quietly infile using "${extractcodedir}\sip90r5"
...
label define rotation
	1           "Interview month: September 1991"
	2           "Interview month:  June 1991"   
	3           "Interview month:  July 1991"   
	4           "Interview month:  August 1991" 
;
...
label define tm9466l 
	0           "Not applicable"                
	1           "20,264 or more - skip to TM9486"
	2           "Less than $20,264"             
;
