log using sip01t5, text replace
set mem 1000m

/*------------------------------------------------

  This program reads the 2001 SIPP Wave 5 Topical Module Data File 
  Note:  This program is distributed under the GNU GPL. See end of
  this file and http://www.gnu.org/licenses/ for details.
  by Jean Roth Thu Jun  1 14:58:43 EDT 2006
...
local dat_name "sipp01t5.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "sipp01t5.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "sip01t5.dct"
