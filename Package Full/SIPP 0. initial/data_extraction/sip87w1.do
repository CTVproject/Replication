log using sip87w1, text replace
set mem 1000m
*This program reads the 1987 SIPP Wave 1 Core Data File 
...
*by Jean Roth Wed Jun  9 16:23:02 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip87w1
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1987\sip87w1.dat"
...
clear
quietly infile using "${extractcodedir}\sip87w1"
...
label define h1_msa  
	...
	41          "Hartford-New Britain-Middletown,"
	42          "Houston, TX"                   
	49          "Los Angeles-Anaheim-Riverside,"
	...
	3160        "Greensville - Spartansburg, SC"
	...
	4900        "Melbourne-Titusville-Palm Bay,"
	4920        "Memphis, TN"                   
	...
	5560        "New Orleans, LA"               
	5720        "Norfolk-VA Beach-Newport News,"
...
label define h1_4838l
	...
	1           "Marked as a reduced-price lunch"
;
...
label define u2_size 
	...
	0           "Not applicable"                
;
label values u2itm38a u2itm38a;
label define u2itm38a
	0           "Not applicable"                
;
label values u2itm38b u2itm38b;
label define u2itm38b
	0           "Not applicable"                
;
...
label define recipsum
	505         "Social security"               
	506         "Railroad retirement"           
	507         "Federal Supplemental Security" 
	509         "State unemployment compensation"
	510         "Supplemental unemployment"     
	511         "Other unemployment compensation"
	512         "Veterans compensation or"      
	514         "Workers compensation"          
	516         "Employer or union temporary"   
	517         "Payments from a sickness,"     
	524         "Aid to families with dependent"
	525         "General assistance or general" 
	527         "Foster child care payments"    
	528         "Other welfare"                 
	529         "WIC"                           
	531         "Food stamps"                   
	532         "Child support payments"        
	533         "Alimony payments"              
	534         "Pension from company or union" 
	535         "Federal civil service or other"
	536         "U.S. military retirement pay"  
	538         "State government pensions"     
	539         "Local government pensions"     
	540         "Income from paid up life"      
	541         "Estates and trusts"            
	542         "Other payments for"            
	544         "GI bill education benefits"    
	554         "Income assistance from a"      
	555         "Money from relatives or friends"
	556         "Lump sum payments"             
	557         "Income from roomers or boarders"
	558         "National guard or reserve pay" 
	559         "Incidental or casual earnings" 
	560         "Other cash income not included"
	579         "Recoded for confidentiality"   
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
...
label define assetsum
	580         "ISS Code 100 - savings accounts"
	581         "ISS Code 101 - money market"   
	582         "ISS Code 102 - certificates of"
	583         "ISS Code 103 - now accounts"   
	584         "ISS Code 104 - money market"   
	585         "ISS Code 105 - U.S. government"
	596         "ISS Code 106 - municipal or"   
	587         "ISS Code 107 - other interest" 
	588         "ISS Code 110 - stocks or"      
	589         "ISS Code 120 - rental property"
	590         "ISS Code 130 - mortgages"      
	591         "ISS Code 140 - royalties"      
	592         "ISS Code 150 - other financial"
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
...
label define incsourc
	...
	75          "Recoded for confidentiality"   
;
...
label define astsourc
	...
	102         "Certificates of deposit or"    
...
label define sc1006l 
	0           "Not marked as a week looking"  
	1           "Marked as a week looking or"   
;
...
label define sc1060l 
	0           "Not marked as absent without"  
...
label define sc1528l 
	0           "Not marked as a month covered" 
...
label define ws1recim
	...
	2           "No"                            
;
label values ws1_amt1 ws1_amtc;
label define ws1_amtc
	-9          "Not in universe                               ^M"
;
...
label define ws1_201c
	...
	2           "A private not for profit company"
...
label define ws1_202k
	0           "Not in universe"               
;
label values ws1_2026 ws1_202l;
label define ws1_202l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to WS1-2030"         
;
label values ws1_2028 ws1_202m;
...
label define ws2recim
	...
	2           "No"                            
;
label values ws2_amt1 ws2_amtc;
label define ws2_amtc
	0           "None"                          
	-9          "Not in universe"               
;
...
label define ws2_202k
	0           "Not in universe"               
;
label values ws2_2026 ws2_202l;
label define ws2_202l
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to WS2-2030"         
;
label values ws2_2028 ws2_202m;
...
label define vet3060l
	0           "Not in universe"               
	1           "Yes - skip to next ISS code or SC4800"
	2           "No - skip to next ISS code or SC4800"
	-1          "DK - skip to next ISS code or SC4800"
;
...
label define ws1_200d
	...
	-9          "Not in universe"               
;
label values ws1_2044 ws1_204d;
...
label define ws2_210d
	...
	-9          "Not in universe"               
;
label values ws2_2144 ws2_214d;
label define ws2_214d
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values ws2_2146 ws2_214k;
...
label define se12201l
	...
	-9          "Not in universe"               
;
label values se22201  se22201l;
label define se22201l
	0           "Not answered"                  
	-9          "Not in universe"               
;
...
label define sc1668l 
	0           "Not in universe"               
	1           "Elementary grades 1-8 skip to" 
...
;
label values ws1_2023 ws1_202p;
label define ws1_202p
	0           "Not in universe"               
	1           "Yes"                           
	2           "No - skip to SC2025"           
;
label values ws1_2024 ws1_202n;
...
;
label values ws1_2025 ws1_202o;
label define ws1_202o
	0           "None"                          
	-9          "Not in universe"               
;
label values ws2_2123 ws2_212p;
...
label define ws2_212l
	...
	-9          " Not in universe"              
;
label values ws1impo9 ws1impop;
label define ws1impop
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values ws2impo9 ws2impop;
label define ws2impop
	0           "Not in universe"               
	1           "101 - 899 = Person No."        
;
