log using sip85w6, text replace
set mem 1000m
*This program reads the 1985 SIPP Wave 6 Core Data File 
...
*by Jean Roth Wed Jun  9 16:45:50 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip85w6
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1985\sip85w6.dat"
...
clear
quietly infile using "${extractcodedir}\sip85w6"
...
label define u_pnsp  
	-09         "Not answered"                  
	0           "Not applicable"                
	899         "Not 'married, spouse present' this month"
;
...
label define sc1054l 
	...
	10          "Inadequate transportation"     
	11          "Other - skip to SC1240"        
;
