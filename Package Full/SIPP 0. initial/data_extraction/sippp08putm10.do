log using sippp08putm10.log, replace

**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 10 Topical Module Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Sat Nov  1 21:16:48 EDT 2014
**  Please report errors to jroth@nber.org
**  run with do sippp08putm10
...
local dat_name "p08putm10.dat"

** The following line should contain the path to your output '.dta' file 

local dta_name "sippp08putm10.dta"

** The following line should contain the path to the data dictionary file 

local dct_name "sippp08putm10.dct"
