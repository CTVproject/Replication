log using sip85w1, text replace
set mem 1000m
*This program reads the 1985 SIPP Wave 1 Core Data File 
...
*by Jean Roth Wed Jun  9 16:39:35 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip85w1
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1985\sip85w1.dat"
...
clear
quietly infile using "${extractcodedir}\sip85w1"
...
label define h1itm36b
	...
	16          "Entire HH institutionalized"   
	17          "Demolished"                    
	...
	27          "(Assigned only during the 2nd" 
	28          "Sample households merged into another"
;
...
label define h3_msa  
	...
	56          "Miami-Fort Lauderdale, FL"     
	63          "Milwaukee-Racine, WI"          
	70          "New York-N. New Jersey-Long Island, NY-NJ-CT"
	77          "Philadelphia-Wilmington-Trenton,"
	78          "Pittsburgh-Beaver Valley, PA"  
	79          "Portland-Vancouver, OR"        
	82          "St. Louis, IL-MO"              
...
label define esr_1l  
	...
	4           "With job one or more weeks, no time spent"
...
label define wksjb1l 
	...
	3           "3 weeks"                       
	4           "4 weeks"                       
	5           "5 weeks (only applicable for months with"
;
...
label define wkswop2l
	...
	3           "3 weeks"                       
	4           "4 weeks"                       
	5           "5 weeks (only applicable for months with 5"
;
...
label define ws2_200d
	...
	9           "Not in universe"               
;
label values ws2_2044 ws2_204d;
label define ws2_204d
	0           "Not in universe"               
	1           "Yes - skip to SC2048"          
	2           " No"                           
;
label values ws2_2046 ws2_204l;
label define ws2_204l
	0           "Not in universe"               
	1           "Yes"                           
	2           " No"                           
;
...
label define h1_type 
	...
	2           "Male householder family household"
	3           "Female householder family household"
	4           "Male householder nonfamily household"
	5           "Female householder nonfamily household"
	6           "Group quarters"                
;
