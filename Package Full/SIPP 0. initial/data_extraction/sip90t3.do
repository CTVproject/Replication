log using sip90t3, text replace
set mem 1000m
*This program reads the 1990 SIPP Wave 3 Topical Module Data File 
*Note:  This program is distributed under the GNU GPL. See end of
*this file and http://www.gnu.org/licenses/ for details.
*by Jean Roth Mon Jun  7 17:35:13 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip90t3
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1990\sip90t3.dat"
...
clear
quietly infile using "${extractcodedir}\sip90t3"
...
label define tm8324l 
	0           "Not applicable"                
	-0002       "All costs already recorded for"
;
