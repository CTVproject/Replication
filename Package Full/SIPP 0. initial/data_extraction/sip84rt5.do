log using sip84rt5, text replace
set mem 1000m
*This program reads the 1984 SIPP Wave 5 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:52:18 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip84rt5
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1984\sip84rt5.dat"
...
clear
quietly infile using "${extractcodedir}\sip84rt5"
...
label define tm8010l 
	...
	2           "CHILD'S BROTHER/SISTER 15+"    
	3           "CHILD'S BROTHER/SISTER UNDER 15"
	4           "CHILD'S GRANDPARENT"           
	5           "OTHER RELATIVE OF CHILD"       
	6           "NONRELATIVE OF CHILD"          
	7           "CHILD IN DAY/GROUP CARE CENTER -"
	8           "CHILD IN NURSERY/PRESCHOOL"    
	9           "CHILD IN KINDERGARTEN, ELEMENTARY OR"
	10          "CHILD CARES FOR SELF - SKIP TO TM8022"
	11          "...WORKS AT HOME - SKIP TO TM8022"
	12          "...CARES FOR CHILD AT WORK - SKIP TO"
	13          "CHILD NOT BORN AS OF LAST MONTH - SKIP"
	14          "...DID NOT WORK LAST MONTH - SKIP TO"
;
...
label define tm8012l 
	...
	5           "OTHER RELATIVE OF CHILD"       
	6           "NONRELATIVE OF CHILD"          
	7           "CHILD IN DAY/GROUP CARE CENTER - SKIP"
	8           "CHILD IN NURSERY/PRESCHOOL"    
	9           "CHILD IN KINDERGARTEN, ELEMENTARY"
	10          "CHILD CARES FOR SELF - SKIP TO TM8024"
	11          "...WORKS AT HOME - SKIP TO TM8024"
	12          "...CARES FOR CHILD AT WORK - SKIP TO"
	13          "CHILD NOT BORN AS OF LAST MONTH - SKIP"
;
...
label define tm8014l 
	...
	8           "CHILD IN NURSERY/PRESCHOOL"    
	9           "CHILD IN KINDERGARTEN, ELEMENTARY"
	10          "CHILD CARES FOR SELF -SKIP TO TM8026"
	11          "...WORKS AT HOME - SKIP TO TM8026"
	12          "...CARES FOR CHILD AT WORK - SKIP TO"
...
label define tm8022l 
	0           "NOT APPLICABLE"                
	1           "YES - SKIP TO NEXT CHILD OR CHECK"
	2           "NO"                            
;
...
label define tm8034l 
	...
	10          "CHILD CARES FOR SELF - SKIP TO NEXT"
	11          "...WORKS AT HOME - SKIP TO NEXT CHILD"
	12          "...CARES FOR CHILD AT WORK - SKIP TO"
;
...
label define tm8036l 
	...
	9           "CHILD IN KINDERGARTEN,"        
	10          "CHILD CARES FOR SELF - SKIP TO NEXT"
	11          "...WORKS AT HOME - SKIP TO NEXT"
	12          "...CARES FOR CHILD AT WORK - SKIP TO"
;
label values tm8038   tm8038l;
label define tm8038l 
	0           "NOT APPLICABLE"                
	1           "CHILD'S PARENT/STEPPARENT"     
	2           "CHILD'S BROTHER/SISTER 15+"    
	3           "CHILD'S BROTHER/SISTER UNDER 15"
	4           "CHILD'S GRANDPARENT"           
	5           "OTHER RELATIVE OF CHILD"       
	6           "NONRELATIVE OF CHILD"          
	7           "CHILD IN DAY/GROUP CARE - SKIP TO"
	8           "CHILD IN NURSERY/PRESCHOOL"    
	9           "CHILD IN KINDERGARTEN,"        
	10          "CHILD CARES FOR SELF - SKIP TO CHECK"
	11          "...WORKS AT HOME - SKIP TO CHECK ITEM"
	12          "...CARES FOR CHILD AT WORK - SKIP TO"
;
...
label define tmimp06l
	...
	1           "IMPUTED"                       
;
label values cal01    cal01l; 
label define cal01l  
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values cal02    cal02l; 
label define cal02l  
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values cal03    cal03l; 
label define cal03l  
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
...
label define tm8066l 
	0           "NOT APPLICABLE"                
	1           "YES - SKIP TO TM8072"          
	2           "NO - SKIP TO CHECK ITEM T7"    
;
...
label define tm8146l 
	0           "NOT APPLICABLE"                
	1           "MARRIED"                       
	2           "WIDOWED - SKIP TO CHECK ITEM T16"
	3           "DIVORCED - SKIP TO TM8152"     
	4           "SEPARATED - SKIP TO TM8152"    
	5           "NEVER MARRIED - SKIP TO TM8152"
;
...
label define tmimp49l
	...
	1           "IMPUTED"                       
;
label values tmimp50  tmimp50l;
label define tmimp50l
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp51  tmimp51l;
label define tmimp51l
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp52  tmimp52l;
label define tmimp52l
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp53  tmimp53l;
label define tmimp53l
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp54  tmimp54l;
label define tmimp54l
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
...
label define tm8274l 
	0           "NOT APPLICABLE"                
	1           "DID NOT WANT THAT KIND OF WORK"
	2           "PAY TOO LOW"                   
	3           "JOB TOO FAR AWAY"              
	4           "LACK TRANSPORTATION"           
	5           "JOB WAS ONLY TEMPORARY"        
	6           "COULDN'T ARRANGE CHILD CARE"   
	7           "HOURS WERE NOT SATISFACTORY"   
	8           "OTHER JOB CONDITIONS WERE NOT" 
...
label define tm8290l 
	...
	2           "ILL OR DISABLED"               
	3           "IN SCHOOL"                     
	4           "COULDN'T ARRANGE CHILD CARE"   
	5           "NO WORK AVAILABLE IN LINE OR AREA"
	6           "RETIRED"                       
	7           "FAMILY RESPONSIBILITIES"       
	8           "ON LAYOFF, EXPECTED TO RETURN TO WORK"
	9           "ALREADY HAD A JOB OR BUSINESS" 
	10          "OTHER"                         
;
...
label define tm8296l 
	...
	1           "GOOD CHANCE"                   
	2           "SOME CHANCE"                   
	3           "LITTLE OR NO CHANCE - SKIP TO TM8324"
;
...
label define tmimp99l
	...
	1           "IMPUTED"                       
;
label values tmimp100 tmimp10n;
label define tmimp10n
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
...
label define tm8354l 
	0           "NOT APPLICABLE"                
;
label values tmimp110 tmimp11n;
label define tmimp11n
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp111 tmimp11k;
label define tmimp11k
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp112 tmimp11m;
label define tmimp11m
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp113 tmimp11o;
label define tmimp11o
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp114 tmimp11p;
label define tmimp11p
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp115 tmimp11q;
label define tmimp11q
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp116 tmimp11r;
label define tmimp11r
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp117 tmimp11s;
label define tmimp11s
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp118 tmimp11t;
label define tmimp11t
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp119 tmimp11u;
label define tmimp11u
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp121 tmimp12n;
label define tmimp12n
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp122 tmimp12k;
label define tmimp12k
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp123 tmimp12m;
label define tmimp12m
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
...
label define tm8384l 
	0           "NOT APPLICABLE"                
	1           "YES - GO TO TM8362 FOR SECOND EMPLOYER"
	2           "NO - END QUESTIONS"            
;
label values tmimp124 tmimp12o;
label define tmimp12o
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp125 tmimp12p;
label define tmimp12p
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp126 tmimp12q;
label define tmimp12q
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp127 tmimp12r;
label define tmimp12r
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp128 tmimp12s;
label define tmimp12s
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp129 tmimp12t;
label define tmimp12t
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp130 tmimp13n;
label define tmimp13n
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp131 tmimp13k;
label define tmimp13k
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp132 tmimp13m;
label define tmimp13m
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp133 tmimp13o;
label define tmimp13o
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp134 tmimp13p;
label define tmimp13p
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
label values tmimp135 tmimp13q;
label define tmimp13q
	0           "NOT IMPUTED"                   
	1           "IMPUTED"                       
;
