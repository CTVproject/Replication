log using sip88rt3, text replace
set mem 1000m
*This program reads the 1988 SIPP Wave 3 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:03:23 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip88rt3
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1988\sip88rt3.dat"
...
clear
quietly infile using "${extractcodedir}\sip88rt3"
