log using sip84rt4, text replace
set mem 1000m

/*------------------------------------------------

  This program reads the 1984 SIPP Wave 4 Rectangular and Topical Data File 
...
****************************************************************
  ...
  by Jean Roth Mon Apr 17 09:07:32 EDT 2006
  Please report errors to jroth@nber.org
  run with do sip84rt4
...
local dat_name "sipp84rt4.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "sipp84rt4.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "${extractcodedir}\sip84rt4.dct"
...
label define incsourc
	...
	12          "Employer or union temporary sickness                                       ^M"
	...
	36          "Income from paid up life insurance                                         ^M"
	37          "Estates and trusts                                                         ^M"
	38          "Other payments for retirement,                                             ^M"
	40          "GI bill education benefits                                                 ^M"
	50          "Income assistance from a                                                   ^M"
	...
	56          "Other cash income not included                                             ^M"
	75          "Recoded for confidentiality (ISS                                           ^M"
;
...
label define tm8544l 
	0           "Not in universe - skip to TM8548"
;
label values tm8546   tm8546l;
label define tm8546l 
	0           "Not in universe - skip to TM8558"
	1           "Value combined with TM8544 for"
;
label values tm8548   tm8548l;
label define tm8548l 
	0           "Not in universe - skip to TM8556"
	1           "Month - skip to TM8556"        
	2           "Year - skip to TM8556"         
	3           "Other - skip to TM8556"        
;
label values tm8556   tm8556l;
label define tm8556l 
	0           "Not in universe - skip to TM8560"
	1           "Yes - skip to TM8560"          
	2           "No - skip to TM8560"           
;
label values tm8558   tm8558l;
label define tm8558l 
	0           "Not in universe - skip to TM8562"
	1           "Yes - skip to TM8562"          
	2           "No - skip to TM8562"           
;
label values tm8560   tm8560l;
label define tm8560l 
	0           "Not in universe - skip to TM8564"
	1           "Yes - skip to TM8564"          
	2           "No - skip to TM8564"           
;
label values tm8562   tm8562l;
label define tm8562l 
	0           "Not in universe - skip to TM8566"
	1           "Yes - skip to TM8566"          
	2           "No - skip to TM8566"           
;
label values tm8564   tm8564l;
label define tm8564l 
	0           "Not in universe - skip to TM8568"
;
label values tm8566   tm8566l;
label define tm8566l 
	0           "Not in universe - skip to TM8570"
	1           "Value combined with TM8564 for public"
;
label values tm8568   tm8568l;
label define tm8568l 
	0           "Not in universe - skip to TM8572"
;
label values tm8570   tm8570l;
label define tm8570l 
	0           "Not in universe - skip to TM8574"
;
label values tm8572   tm8572l;
label define tm8572l 
	0           "Not in universe - skip to TM8576"
;
label values tm8574   tm8574l;
label define tm8574l 
	0           "Not in universe - skip to TM8578"
	1           "Value combined with TM8572 for public"
;
label values tm8576   tm8576l;
label define tm8576l 
	-8          "Not fixed - skip to TM8580"    
	0           "Not in universe - skip to TM8580"
;
label values tm8578   tm8578l;
label define tm8578l 
	-8          "Not fixed - skip to TM8582"    
	0           "Not in universe - skip to TM8582"
;
label values tm8580   tm8580l;
label define tm8580l 
	0           "Not in universe - skip to TM8584"
;
label values tm8582   tm8582l;
label define tm8582l 
	0           "Not in universe - skip to TM8586"
;
label values tm8584   tm8584l;
label define tm8584l 
	0           "Not in universe - skip to TM8588"
	1           "Yes - skip to TM8588"          
	2           "No - skip to TM8588"           
;
label values tm8586   tm8586l;
label define tm8586l 
	0           "Not in universe - skip to TM8590"
	1           "Yes - skip to TM8590"          
	2           "No - skip to TM8590"           
;
label values tm8588   tm8588l;
label define tm8588l 
	0           "Not in universe - skip to TM8592"
	1           "Yes - skip to TM8592"          
	2           "No - skip to TM8592"           
;
label values tm8590   tm8590l;
label define tm8590l 
	0           "Not in universe - skip to TM8594"
	1           "Yes - skip to TM8594"          
	2           "No - skip to  TM8594"          
;
label values tm8592   tm8592l;
label define tm8592l 
	0           "Not in universe"               
	1           "Yes - skip to TM8546"          
	2           "No - skip to  TM8598"          
;
...
label define tm8596l 
	0           "Not in universe"               
	1           "Value combined with TM8564 for"
;
...
label define tm8636l 
	-0007       "Not an owner - skip to TM8646" 
	0           "Not in universe - skip to TM864"
;
...
label define tm8764l 
	0           "Not in universe - skip to TM877"
;
label values tm8766   tm8766l;
label define tm8766l 
	0           "Not in universe - skip to TM8770"
	1           "Yes - skip to TM8720 for vehicle 2"
	2           "No - skip to TM8770"           
;
label values tm8768   tm8768l;
label define tm8768l 
	0           "Not in universe"               
	1           "Yes - skip to TM8722 for vehicle 3"
	2           "No - skip to TM8770"           
;
label values tm8770   tm8770l;
label define tm8770l 
	0           "Not mark as a kind of vehicle" 
	1           "Marked as a kind of vehicle"   
;
...
label define tm8800l 
	...
	2           "No"                            
;
label values tmcarvl1 tmcarvln;
label define tmcarvln
	0           "Not in universe"               
;
label values tmcarvl2 tmcarvlk;
label define tmcarvlk
	0           "Not in universe"               
;
label values tmcarvl3 tmcarvll;
label define tmcarvll
	0           "Not in universe"               
;
label values hhmortg  hhmortg;
label define hhmortg 
	0           "Out of universe"               
;
label values hhtheq   hhtheq; 
label define hhtheq  
	0           "Out of universe"               
;
label values hhvehcl  hhvehcl;
label define hhvehcl 
	0           "Out of universe"               
;
label values hhbeq    hhbeq;  
label define hhbeq   
	0           "Out of universe"               
;
label values hhintbk  hhintbk;
label define hhintbk 
	0           "Out of universe"               
;
label values hhintot  hhintot;
label define hhintot 
	0           "Out of universe"               
;
label values hhstk    hhstk;  
label define hhstk   
	0           "Out of universe"               
;
label values hhore    hhore;  
label define hhore   
	0           "Out of universe"               
;
label values hhotast  hhotast;
label define hhotast 
	0           "Out of universe"               
;
label values hhira    hhira;  
label define hhira   
	0           "Out of universe"               
;
label values hhtwlth  hhtwlth;
label define hhtwlth 
	0           "Out of universe"               
;
label values hhscdbt  hhscdbt;
label define hhscdbt 
	0           "Out of universe"               
;
label values hhusdbt  hhusdbt;
label define hhusdbt 
	0           "Out of universe"               
;
label values hhdebt   hhdebt; 
label define hhdebt  
	0           "Out of universe"               
;
label values hhtnw    hhtnw;  
label define hhtnw   
	0           "Out of universe"               
;
label values hhatsum  hhatsum;
label define hhatsum 
	0           "Not applicable or no"          
	1           "Yes"                           
;
label values tmip138  tmip138l;
label define tmip138l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip139  tmip139l;
label define tmip139l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip140  tmip140l;
label define tmip140l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip141  tmip141l;
label define tmip141l
	0           "Not imputed"                   
	1           "Imputed TM8544"                
	2           "Imputed TM8548"                
	3           "Imputed TM8544 and TM8548"     
;
label values tmip142  tmip142l;
label define tmip142l
	0           "Not imputed"                   
	1           "Imputed TM8546"                
	2           "Imputed TM8550"                
	3           "Imputed TM8546 & TM8550"       
;
label values tmip143  tmip143l;
label define tmip143l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip144  tmip144l;
label define tmip144l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip145  tmip145l;
label define tmip145l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip146  tmip146l;
label define tmip146l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip147  tmip147l;
label define tmip147l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip148  tmip148l;
label define tmip148l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip149  tmip149l;
label define tmip149l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip150  tmip150l;
label define tmip150l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip151  tmip151l;
label define tmip151l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip152  tmip152l;
label define tmip152l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip153  tmip153l;
label define tmip153l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip154  tmip154l;
label define tmip154l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip155  tmip155l;
label define tmip155l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip156  tmip156l;
label define tmip156l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip157  tmip157l;
label define tmip157l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip158  tmip158l;
label define tmip158l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip159  tmip159l;
label define tmip159l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip160  tmip160l;
label define tmip160l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip161  tmip161l;
label define tmip161l
	0           "Not imputed"                   
	1           "Imputed TM8614"                
	2           "Imputed TM8616"                
	3           "Imputed TM8614 & TM8616"       
;
label values tmip162  tmip162l;
label define tmip162l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip163  tmip163l;
label define tmip163l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip164  tmip164l;
label define tmip164l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip165  tmip165l;
label define tmip165l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip166  tmip166l;
label define tmip166l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip167  tmip167l;
label define tmip167l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip168  tmip168l;
label define tmip168l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip169  tmip169l;
label define tmip169l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip170  tmip170l;
label define tmip170l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip171  tmip171l;
label define tmip171l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip172  tmip172l;
label define tmip172l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip173  tmip173l;
label define tmip173l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip174  tmip174l;
label define tmip174l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip175  tmip175l;
label define tmip175l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip176  tmip176l;
label define tmip176l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip177  tmip177l;
label define tmip177l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip178  tmip178l;
label define tmip178l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip179  tmip179l;
label define tmip179l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip180  tmip180l;
label define tmip180l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip181  tmip181l;
label define tmip181l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip182  tmip182l;
label define tmip182l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip183  tmip183l;
label define tmip183l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip184  tmip184l;
label define tmip184l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip185  tmip185l;
label define tmip185l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip186  tmip186l;
label define tmip186l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip187  tmip187l;
label define tmip187l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip188  tmip188l;
label define tmip188l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip189  tmip189l;
label define tmip189l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip190  tmip190l;
label define tmip190l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip191  tmip191l;
label define tmip191l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip192  tmip192l;
label define tmip192l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip193  tmip193l;
label define tmip193l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip194  tmip194l;
label define tmip194l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip195  tmip195l;
label define tmip195l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip196  tmip196l;
label define tmip196l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip197  tmip197l;
label define tmip197l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip198  tmip198l;
label define tmip198l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip199  tmip199l;
label define tmip199l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip200  tmip200l;
label define tmip200l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip201  tmip201l;
label define tmip201l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip202  tmip202l;
label define tmip202l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip203  tmip203l;
label define tmip203l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip204  tmip204l;
label define tmip204l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip205  tmip205l;
label define tmip205l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip206  tmip206l;
label define tmip206l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip207  tmip207l;
label define tmip207l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip208  tmip208l;
label define tmip208l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip209  tmip209l;
label define tmip209l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip210  tmip210l;
label define tmip210l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip211  tmip211l;
label define tmip211l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip212  tmip212l;
label define tmip212l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip213  tmip213l;
label define tmip213l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip214  tmip214l;
label define tmip214l
	0           "Not Imputed"                   
	1           "Imputed"                       
;
label values tmip215  tmip215l;
label define tmip215l
	0           "Not Imputed"                   
	1           "Imputed"                       
;
label values tmip216  tmip216l;
label define tmip216l
	0           "Not Imputed"                   
	1           "Imputed"                       
;
label values tmip217  tmip217l;
label define tmip217l
	0           "Not Imputed"                   
	1           "Imputed"                       
;
label values tmcal11  tmcal11l;
label define tmcal11l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal12  tmcal12l;
label define tmcal12l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal13  tmcal13l;
label define tmcal13l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal14  tmcal14l;
label define tmcal14l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal15  tmcal15l;
label define tmcal15l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal16  tmcal16l;
label define tmcal16l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal17  tmcal17l;
label define tmcal17l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal18  tmcal18l;
label define tmcal18l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal19  tmcal19l;
label define tmcal19l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal20  tmcal20l;
label define tmcal20l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal21  tmcal21l;
label define tmcal21l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal22  tmcal22l;
label define tmcal22l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal23  tmcal23l;
label define tmcal23l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal24  tmcal24l;
label define tmcal24l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal25  tmcal25l;
label define tmcal25l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal26  tmcal26l;
label define tmcal26l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal27  tmcal27l;
label define tmcal27l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal28  tmcal28l;
label define tmcal28l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal29  tmcal29l;
label define tmcal29l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal30  tmcal30l;
label define tmcal30l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal31  tmcal31l;
label define tmcal31l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal32  tmcal32l;
label define tmcal32l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal33  tmcal33l;
label define tmcal33l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal34  tmcal34l;
label define tmcal34l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal35  tmcal35l;
label define tmcal35l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal36  tmcal36l;
label define tmcal36l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmbusvl1 tmbusvlm;
label define tmbusvlm
	-3          "None"                          
;
label values tmbusvl2 tmbusvlk;
label define tmbusvlk
	-3          "None"                          
;
label values tmbusdt1 tmbusdtm;
label define tmbusdtm
	-3          "None"                          
;
label values tmbusdt2 tmbusdtk;
label define tmbusdtk
	-3          "None"                          
;
...
label define tm8024l 
	...
	0           "Not in universe"               
	1           "Value combined with TM8008 for"
;
label values tm8028   tm8028l;
label define tm8028l 
	-3          "None - skip to SC4314"         
	0           "Not in universe"               
	1           "Value combined with TM8012 for"
;
label values tmip001  tmip001l;
label define tmip001l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip002  tmip002l;
label define tmip002l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip003  tmip003l;
label define tmip003l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip004  tmip004l;
label define tmip004l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip005  tmip005l;
label define tmip005l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip006  tmip006l;
label define tmip006l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip007  tmip007l;
label define tmip007l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip008  tmip008l;
label define tmip008l
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm8054l 
	-3          "None - skip to SC8076"         
	0           "Not in universe"               
;
label values tm8056   tm8056l;
label define tm8056l 
	0           "Not marked as a kind of property"
	1           "Marked as a kind of property"  
;
...
label define tm8132l 
	...
	0           "Not in universe"               
;
label values tmip009  tmip009l;
label define tmip009l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip010  tmip010l;
label define tmip010l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip011  tmip011l;
label define tmip011l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip012  tmip012l;
label define tmip012l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip013  tmip013l;
label define tmip013l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip014  tmip014l;
label define tmip014l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip015  tmip015l;
label define tmip015l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip016  tmip016l;
label define tmip016l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip017  tmip017l;
label define tmip017l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip018  tmip018l;
label define tmip018l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip019  tmip019l;
label define tmip019l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip020  tmip020l;
label define tmip020l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip021  tmip021l;
label define tmip021l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip022  tmip022l;
label define tmip022l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip023  tmip023l;
label define tmip023l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip024  tmip024l;
label define tmip024l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip025  tmip025l;
label define tmip025l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip026  tmip026l;
label define tmip026l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip027  tmip027l;
label define tmip027l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip028  tmip028l;
label define tmip028l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip029  tmip029l;
label define tmip029l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip030  tmip030l;
label define tmip030l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip031  tmip031l;
label define tmip031l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip032  tmip032l;
label define tmip032l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip033  tmip033l;
label define tmip033l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip034  tmip034l;
label define tmip034l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip035  tmip035l;
label define tmip035l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip036  tmip036l;
label define tmip036l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip037  tmip037l;
label define tmip037l
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm8268l 
	0           "Not marked as a kind of IRA"   
	1           "Marked as a kind of IRA account"
;
...
label define tm8292l 
	0           "Not marked as a kind of KEOGH" 
	1           "Marked as a kind of KEOGH account"
;
...
label define tm8310l 
	0           "Not in universe - skip to"     
;
label values tmip038  tmip038l;
label define tmip038l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip039  tmip039l;
label define tmip039l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip040  tmip040l;
label define tmip040l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip041  tmip041l;
label define tmip041l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip042  tmip042l;
label define tmip042l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip043  tmip043l;
label define tmip043l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip044  tmip044l;
label define tmip044l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip045  tmip045l;
label define tmip045l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip046  tmip046l;
label define tmip046l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip047  tmip047l;
label define tmip047l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip048  tmip048l;
label define tmip048l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip049  tmip049l;
label define tmip049l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip050  tmip050l;
label define tmip050l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip051  tmip051l;
label define tmip051l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip052  tmip052l;
label define tmip052l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip053  tmip053l;
label define tmip053l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip054  tmip054l;
label define tmip054l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip055  tmip055l;
label define tmip055l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip056  tmip056l;
label define tmip056l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip057  tmip057l;
label define tmip057l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip058  tmip058l;
label define tmip058l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip059  tmip059l;
label define tmip059l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip060  tmip060l;
label define tmip060l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip061  tmip061l;
label define tmip061l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip062  tmip062l;
label define tmip062l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip063  tmip063l;
label define tmip063l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip064  tmip064l;
label define tmip064l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip065  tmip065l;
label define tmip065l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip066  tmip066l;
label define tmip066l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip067  tmip067l;
label define tmip067l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip068  tmip068l;
label define tmip068l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip069  tmip069l;
label define tmip069l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip070  tmip070l;
label define tmip070l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip071  tmip071l;
label define tmip071l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip072  tmip072l;
label define tmip072l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip073  tmip073l;
label define tmip073l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip074  tmip074l;
label define tmip074l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip075  tmip075l;
label define tmip075l
	0           "Not imputed"                   
	1           "Imputed"                       
;
...
label define tm8312l 
	0           "Not in universe"               
	1           "Less than 25 years of age - skip"
	2           "25 to 39 years of age - skip to"
	3           "40 to 65 years of age"         
	4           "66 years of age or older - skip"
;
label values tm8314   tm8314l;
label define tm8314l 
	0           "Not in universe"               
	1           "Yes - skip to TM8318"          
	2           "No"                            
;
...
label define tm8318l 
	0           "Not in universe"               
	1           "Never worked - skip to TM8526" 
	2           "Already stopped - skip to TM8324"
	3           "Doesn't plan to stop - skip to"
;
...
label define tm8326l 
	0           "Not in universe - skip to TM8330"
;
label values tm8328   tm8328l;
label define tm8328l 
	0           "Not in universe - skip to TM8332"
;
label values tm8330   tm8330l;
label define tm8330l 
	0           "Not in universe - skip to TM8334"
	1           "Under 25 - skip to TM8334"     
	2           "25 to 99 - skip to TM8334"     
	3           "100 to 499 - skip to TM8334"   
	4           "500 to 999 - skip to TM8334"   
	5           "1000 or more - skip to TM8342" 
;
label values tm8332   tm8332l;
label define tm8332l 
	0           "Not in universe - skip to TM8336"
	1           "Under 25 - skip to TM8336"     
	2           "25 to 99 - skip to TM8336"     
	3           "100 to 499 - skip to TM8336"   
	4           "500 to 999 - skip to TM8336"   
	5           "1000 or more - skip to TM8344" 
;
label values tm8334   tm8334l;
label define tm8334l 
	0           "Not in universe - skip to TM8338"
	1           "Yes - skip to TM8338"          
	2           "No - skip to TM8342"           
;
label values tm8336   tm8336l;
label define tm8336l 
	0           "Not in universe - skip to TM8340"
	1           "Yes - skip to TM8340"          
	2           "No - skip to TM8342"           
;
label values tm8338   tm8338l;
label define tm8338l 
	0           "Not in universe - skip to TM8342"
	1           "Under 25 - skip to TM8342"     
	2           "25 to 99 - skip to TM8342"     
	3           "100 to 499 - skip to TM8342"   
	4           "500 to 999 - skip to TM8342"   
	5           "1000 or more - skip to TM8342" 
;
label values tm8340   tm8340l;
label define tm8340l 
	0           "Not in universe - skip to TM8344"
	1           "Under 25 - skip to TM8344"     
	2           "25 to 99 - skip to TM8344"     
	3           "100 to 499 - skip to TM8344"   
	4           "500 to 999 - skip to TM8344"   
	5           "1000 or more - skip to TM8344" 
;
label values tm8342   tm8342l;
label define tm8342l 
	0           "Not in universe - skip to TM8346"
	1           "Yes - skip to TM8346"          
	2           "No - skip to TM8382"           
;
label values tm8344   tm8344l;
label define tm8344l 
	0           "Not in universe - skip to TM8348"
	1           "Yes - skip to TM8348"          
	2           "No - skip to TM8384"           
;
label values tm8346   tm8346l;
label define tm8346l 
	0           "Not in universe - skip to TM8350"
	1           "Yes- skip to TM8384"           
	2           "No - skip to TM8350"           
;
label values tm8348   tm8348l;
label define tm8348l 
	0           "Not in universe - skip to TM8352"
	1           "Yes - skip to TM8386"          
	2           "No - skip to TM8352"           
;
label values tm8350   tm8350l;
label define tm8350l 
	0           "Not marked as a kind of reason"
	1           "Marked as a kind of reason"    
;
...
label define tm8384l 
	0           "Not in universe - skip to TM8388"
	1           "Yes - skip to TM8388"          
	2           "No - skip to TM8388"           
;
label values tm8386   tm8386l;
label define tm8386l 
	0           "Not in universe - skip to TM8390"
	1           "Yes - skip to TM8390"          
	2           "No - skip to TM8390"           
;
label values tm8388   tm8388l;
label define tm8388l 
	0           "Not in universe - skip to TM8392"
	1           "Yes - skip to TM8396"          
	2           "No - skip to TM8392"           
;
label values tm8390   tm8390l;
label define tm8390l 
	0           "Not in universe - skip to TM8394"
	1           "Yes - skip to TM8398"          
	2           "No - skip to TM8394"           
;
label values tm8392   tm8392l;
label define tm8392l 
	0           "Not in universe - skip to TM8396"
	1           "Based on years of service and pay"
	2           "Based on the amount contributed"
;
label values tm8394   tm8394l;
label define tm8394l 
	0           "Not in universe - skip to TM8398"
	1           "Based on years of service and pay"
	2           "Based on the amount contributed"
;
label values tm8396   tm8396l;
label define tm8396l 
	0           "Not in universe - skip to TM8400"
	1           "Yes - skip to TM8400"          
	2           "No - skip to TM8400"           
;
label values tm8398   tm8398l;
label define tm8398l 
	0           "Not in universe - skip to TM8402"
	1           "Yes - skip to TM8402"          
	2           "No - skip to TM8402"           
;
label values tm8400   tm8400l;
label define tm8400l 
	0           "Not in universe - skip to TM8404"
	1           "Yes - skip to TM8404"          
	2           "No - skip to TM8420"           
;
label values tm8402   tm8402l;
label define tm8402l 
	0           "Not in universe - skip to TM8406"
	1           "Yes - skip to TM8406"          
	2           "No - skip to TM8422"           
;
label values tm8404   tm8404l;
label define tm8404l 
	0           "Not in universe - skip to TM8408"
;
label values tm8406   tm8406l;
label define tm8406l 
	0           "Not in universe - skip to TM8410"
;
label values tm8408   tm8408l;
label define tm8408l 
	0           "Not in universe - skip to TM8412"
	1           "Week - skip to TM8412"         
	2           "Biweekly - skip to TM8412"     
	3           "Month - skip to TM8412"        
	4           "Quarter - skip to TM8412"      
	5           "Year - skip to TM8412"         
;
label values tm8410   tm8410l;
label define tm8410l 
	0           "Not in universe - skip to TM8414"
	1           "Week - skip to TM8414"         
	2           "Biweekly - skip to TM8414"     
	3           "Month - skip to TM8414"        
	4           "Quarter - skip to TM8414"      
	5           "Year - skip to TM8414"         
;
label values tm8412   tm8412l;
label define tm8412l 
	0           "Not in universe - skip to TM8420"
;
...
label define tm8450l 
	0           "Not in universe - skip to TM8454"
;
label values tm8452   tm8452l;
label define tm8452l 
	0           "Not in universe - skip to TM8456"
;
label values tm8454   tm8454l;
label define tm8454l 
	0           "Not in universe - skip to TM8458"
...
label define tm8462l 
	0           "Not mark as a kind of business"
	1           "Marked as a kind of business"  
;
...
label define tm8524l 
	...
	2           "No"                            
;
label values tmip076  tmip076l;
label define tmip076l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip077  tmip077l;
label define tmip077l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip078  tmip078l;
label define tmip078l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip079  tmip079l;
label define tmip079l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip080  tmip080l;
label define tmip080l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip081  tmip081l;
label define tmip081l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip082  tmip082l;
label define tmip082l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip083  tmip083l;
label define tmip083l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip084  tmip084l;
label define tmip084l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip085  tmip085l;
label define tmip085l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip086  tmip086l;
label define tmip086l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip087  tmip087l;
label define tmip087l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip088  tmip088l;
label define tmip088l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip089  tmip089l;
label define tmip089l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip090  tmip090l;
label define tmip090l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip091  tmip091l;
label define tmip091l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip092  tmip092l;
label define tmip092l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip093  tmip093l;
label define tmip093l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip094  tmip094l;
label define tmip094l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip095  tmip095l;
label define tmip095l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip096  tmip096l;
label define tmip096l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip097  tmip097l;
label define tmip097l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip098  tmip098l;
label define tmip098l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip099  tmip099l;
label define tmip099l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip100  tmip100l;
label define tmip100l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip101  tmip101l;
label define tmip101l
	0           "Not imputed"                   
	1           "Imputed TM8404"                
	2           "Imputed TM8408"                
	3           "Imputed TM8404 & TM8408"       
;
label values tmip102  tmip102l;
label define tmip102l
	0           "Not imputed"                   
	1           "Imputed TM8406"                
	2           "Imputed TM8410"                
	3           "Imputed TM8406 & TM8410"       
;
label values tmip103  tmip103l;
label define tmip103l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip104  tmip104l;
label define tmip104l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip105  tmip105l;
label define tmip105l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip106  tmip106l;
label define tmip106l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip107  tmip107l;
label define tmip107l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip108  tmip108l;
label define tmip108l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip109  tmip109l;
label define tmip109l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip110  tmip110l;
label define tmip110l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip111  tmip111l;
label define tmip111l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip112  tmip112l;
label define tmip112l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip113  tmip113l;
label define tmip113l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip114  tmip114l;
label define tmip114l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip115  tmip115l;
label define tmip115l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip116  tmip116l;
label define tmip116l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip117  tmip117l;
label define tmip117l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip118  tmip118l;
label define tmip118l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip119  tmip119l;
label define tmip119l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip120  tmip120l;
label define tmip120l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip121  tmip121l;
label define tmip121l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip122  tmip122l;
label define tmip122l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip123  tmip123l;
label define tmip123l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip124  tmip124l;
label define tmip124l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip125  tmip125l;
label define tmip125l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip126  tmip126l;
label define tmip126l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip127  tmip127l;
label define tmip127l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip128  tmip128l;
label define tmip128l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip129  tmip129l;
label define tmip129l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip130  tmip130l;
label define tmip130l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip131  tmip131l;
label define tmip131l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip132  tmip132l;
label define tmip132l
	0           "Not imputed"                   
	1           "Imputed TM8508"                
	2           "Imputed TM8510"                
	3           "Imputed TM8508 & TM8510"       
;
label values tmip133  tmip133l;
label define tmip133l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip134  tmip134l;
label define tmip134l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip135  tmip135l;
label define tmip135l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip136  tmip136l;
label define tmip136l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmip137  tmip137l;
label define tmip137l
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmipind  tmipind;
label define tmipind 
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmipocp  tmipocp;
label define tmipocp 
	0           "Not imputed"                   
	1           "Imputed"                       
;
label values tmcal01  tmcal01l;
label define tmcal01l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal02  tmcal02l;
label define tmcal02l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal03  tmcal03l;
label define tmcal03l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal04  tmcal04l;
label define tmcal04l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal05  tmcal05l;
label define tmcal05l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal06  tmcal06l;
label define tmcal06l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal07  tmcal07l;
label define tmcal07l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal08  tmcal08l;
label define tmcal08l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal09  tmcal09l;
label define tmcal09l
	0           "Not calculated"                
	1           "Calculated"                    
;
label values tmcal10  tmcal10l;
label define tmcal10l
	0           "Not calculated"                
;
