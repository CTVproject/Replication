log using sip87rt4, text replace
set mem 1000m
*This program reads the 1987 SIPP Wave 4 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:19:30 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip87rt4
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1987\sip87rt4.dat"
...
clear
quietly infile using "${extractcodedir}\sip87rt4"
