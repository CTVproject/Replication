log using sip93t6, text replace
set mem 1000m
*This program reads the 1993 SIPP Wave 6 Topical Module Data File 
...
*by Jean Roth Thu Mar 18 11:54:32 EST 2004
*Please report errors to jroth@nber.org
*run with do sip93t6
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1993\sip93t6.dat"
...
clear
quietly infile using "${extractcodedir}\sip93t6"
...
label define tm9044l 
	0           "Not applicable"                
	10600       "The amount of child support"   
	-1          "Dk"                            
;
