log using sip87rt6, replace
set mem 500m
*This program reads the 1987 SIPP Wave 6 Rectangular and Topical Data File 
...
*by Jean Roth Mon Jun  9 15:08:41 EDT 2003
*Please report errors to jroth@nber.org
*run with do sip87rt6
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp/1987\sip87rt6.dat"
...
clear
quietly infile using "${extractcodedir}\sip87rt6"
...
label define pp_mis_n
	...
	2           "Noninterview"                  
;
label values pw_addid pw_addid;
label define pw_addid
