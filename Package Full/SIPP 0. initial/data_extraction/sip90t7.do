log using sip90t7, text replace
set mem 1000m
*This program reads the 1990 SIPP Wave 7 Topical Module Data File 
*Note:  This program is distributed under the GNU GPL. See end of
*this file and http://www.gnu.org/licenses/ for details.
*by Jean Roth Mon Jun  7 17:38:08 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip90t7
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1990\sip90t7.dat"
...
local dat_name "sipp90t7.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "sipp90t7.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "sip90t7.dct"
...
;
label values pp_mis1  pp_mis1;
label define pp_mis1
	1           "Interview"                     
	2           "Non-interview"                 
;
label values pp_mis2  pp_mis1;
*label define pp_mis
	1           "Interview"                     
	2           "Non-interview"                 
;
label values pp_mis3  pp_mis1;
*label define pp_mis
	1           "Interview"                     
	2           "Non-interview"                 
;
label values pp_mis4  pp_mis1;
*label define pp_mis
	1           "Interview"                     
	2           "Non-interview"                 
;
label values pp_mis5  pp_mis1;
