log using sip92t4, text replace
set mem 1000m
*This program reads the 1992 SIPP Wave 4 Topical Module Data File 
*Note:  This program is distributed under the GNU GPL. See end of
*this file and http://www.gnu.org/licenses/ for details.
*by Jean Roth Mon Jun  7 18:29:45 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip92t4
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1992\sip92t4.dat"
...
clear
quietly infile using "${extractcodedir}\sip92t4"
...
label define tm4322l 
	3           "None"                          
;
label values tm4320   tm4320l;
label define tm4320l 
	-3          "None"                          
;
...
label define tm4422l 
	3           "None"                          
;
label values tm4420   tm4420l;
label define tm4420l 
	-3          "None"                          
;
