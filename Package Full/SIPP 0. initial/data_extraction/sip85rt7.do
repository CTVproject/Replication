log using sip85rt7, text replace
set mem 1000m
*This program reads the 1985 SIPP Wave 7 Rectangular and Topical Data File 
...
*by Jean Roth Wed Jun  9 16:35:33 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip85rt7
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1985\sip85rt7.dat"
...
clear
quietly infile using "${extractcodedir}\sip85rt7"
