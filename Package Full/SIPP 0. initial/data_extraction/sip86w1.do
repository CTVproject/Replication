log using sip86w1, text replace
set mem 1000m
*This program reads the 1986 SIPP Wave 1 Core Data File 
...
*by Jean Roth Wed Jun  9 16:39:58 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip86w1
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1986\sip86w1.dat"
...
clear
quietly infile using "${extractcodedir}\sip86w1"
...
label define pp_mis5l
	...
	2           "Noninterview"                  
;
label values u_yrent  u_yrent;
label define u_yrent 
	0           "Not in universe"               
;
label values u_yrent2 u_yrentt;
label define u_yrentt
	0           "Not in universe"               
;
